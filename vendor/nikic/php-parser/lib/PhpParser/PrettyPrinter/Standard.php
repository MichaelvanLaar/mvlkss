...
class Standard extends PrettyPrinterAbstract {
    ...
    protected function pParam(Node\Param $node): string {
        return $this->pAttrGroups(
            $node->attrGroups,
            $this->phpVersion->supportsAttributes(),
        ) .
            ...
            ($node->hooks
                ? " {" . $this->pStmts($node->hooks) . $this->nl . "}"
                : "");
    }
    ...
    protected function pVariadicPlaceholder(
        Node\VariadicPlaceholder $node,
    ): string {
        return "...";
    }
    ...
    protected function pVarLikeIdentifier(
        Node\VarLikeIdentifier $node,
    ): string {
        return '$' . $node->name;
    }
    ...
    protected function pScalar_MagicConst_Class(
        MagicConst\Class_ $node,
    ): string {
        return "__CLASS__";
    }
    ...
    protected function pScalar_MagicConst_Method(
        MagicConst\Method $node,
    ): string {
        return "__METHOD__";
    }
    ...
    protected function pScalar_MagicConst_Trait(
        MagicConst\Trait_ $node,
    ): string {
        return "__TRAIT__";
    }

    protected function pScalar_MagicConst_Property(
        MagicConst\Property $node,
    ): string {
        return "__PROPERTY__";
    }
        ...
        switch ($kind) {
            ...
            case Scalar\String_::KIND_HEREDOC:
                ...
                if ($label && !$this->containsEndLabel($escaped, $label)) {
                    $nl = $this->phpVersion->supportsFlexibleHeredoc()
                        ? $this->nl
                        : $this->newline;
                    if ($escaped === "") {
                        return "<<<$label$nl$label{$this->docStringEndToken}";
    ...
    protected function pScalar_InterpolatedString(
    ...
    protected function pExpr_Assign(
        Expr\Assign $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_AssignRef(
        Expr\AssignRef $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_AssignOp_Plus(
        AssignOp\Plus $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_AssignOp_Minus(
        AssignOp\Minus $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_AssignOp_Mul(
        AssignOp\Mul $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_AssignOp_Div(
        AssignOp\Div $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_AssignOp_Concat(
    ...
    protected function pExpr_AssignOp_Mod(
        AssignOp\Mod $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_AssignOp_BitwiseOr(
        AssignOp\BitwiseOr $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pPrefixOp(
    ...
    protected function pExpr_AssignOp_Pow(
        AssignOp\Pow $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_AssignOp_Coalesce(
        AssignOp\Coalesce $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pPrefixOp(
    ...
    protected function pExpr_BinaryOp_Mul(
        BinaryOp\Mul $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_BinaryOp_Div(
        BinaryOp\Div $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_BinaryOp_Concat(
    ...
    protected function pExpr_BinaryOp_Mod(
        BinaryOp\Mod $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_BinaryOp_BooleanOr(
        BinaryOp\BooleanOr $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pInfixOp(
    ...
    protected function pExpr_BinaryOp_BitwiseOr(
        BinaryOp\BitwiseOr $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pInfixOp(
    ...
    protected function pExpr_BinaryOp_ShiftLeft(
        BinaryOp\ShiftLeft $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pInfixOp(
    ...
    protected function pExpr_BinaryOp_Pow(
        BinaryOp\Pow $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_BinaryOp_LogicalOr(
        BinaryOp\LogicalOr $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pInfixOp(
    ...
    protected function pExpr_BinaryOp_Equal(
        BinaryOp\Equal $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_BinaryOp_NotEqual(
        BinaryOp\NotEqual $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pInfixOp(
    ...
    protected function pExpr_BinaryOp_Identical(
    ...
    protected function pExpr_BinaryOp_Spaceship(
        BinaryOp\Spaceship $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pInfixOp(
    ...
    protected function pExpr_BinaryOp_Greater(
        BinaryOp\Greater $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pInfixOp(
    ...
    protected function pExpr_BinaryOp_Smaller(
        BinaryOp\Smaller $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pInfixOp(
    ...
    protected function pExpr_BinaryOp_Coalesce(
        BinaryOp\Coalesce $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pInfixOp(
    ...
    protected function pExpr_BinaryOp_Pipe(
        BinaryOp\Pipe $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_BooleanNot(
        Expr\BooleanNot $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pPrefixOp(
    ...
    protected function pExpr_BitwiseNot(
        Expr\BitwiseNot $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pPrefixOp(
    ...
    protected function pExpr_UnaryMinus(
        Expr\UnaryMinus $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pPrefixOp(
    ...
    protected function pExpr_ErrorSuppress(
        Expr\ErrorSuppress $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
        return $this->pPrefixOp(
    ...
    protected function pExpr_YieldFrom(
        Expr\YieldFrom $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Print(
        Expr\Print_ $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Cast_Int(
        Cast\Int_ $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Cast_Double(
        Cast\Double $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Cast_String(
        Cast\String_ $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Cast_Array(
        Cast\Array_ $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Cast_Object(
        Cast\Object_ $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Cast_Bool(
        Cast\Bool_ $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Cast_Unset(
        Cast\Unset_ $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Cast_Void(
        Cast\Void_ $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Include(
        Expr\Include_ $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_List(Expr\List_ $node): string {
        $syntax = $node->getAttribute(
            "kind",
            $this->phpVersion->supportsShortArrayDestructuring()
                ? Expr\List_::KIND_ARRAY
                : Expr\List_::KIND_LIST,
        );
    ...
    protected function pExpr_Clone(
        Expr\Clone_ $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Ternary(
        Expr\Ternary $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Throw(
        Expr\Throw_ $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pExpr_Yield(
        Expr\Yield_ $node,
        int $precedence,
        int $lhsPrecedence,
    ): string {
    ...
    protected function pStmt_Namespace(Stmt\Namespace_ $node): string {
        if ($this->canUseSemicolonNamespaces) {
            ...
            return "namespace" .
                (null !== $node->name ? " " . $this->p($node->name) : "") .
                " {" .
                $this->pStmts($node->stmts) .
                $this->nl .
                "}";
    ...
    protected function pUseType(int $type): string {
        return $type === Stmt\Use_::TYPE_FUNCTION
            ? "function "
    ...
    protected function pStmt_Interface(Stmt\Interface_ $node): string {
        return $this->pAttrGroups($node->attrGroups) .
            ...
            $node->name .
            (!empty($node->extends)
                ? " extends " . $this->pCommaSeparated($node->extends)
                : "") .
            $this->nl .
            "{" .
            $this->pStmts($node->stmts) .
    ...
    protected function pStmt_TraitUseAdaptation_Precedence(
        ...
        return $this->p($node->trait) .
            "::" .
            $node->method .
            " insteadof " .
            $this->pCommaSeparated($node->insteadof) .
            ";";
    }
    ...
    protected function pStmt_TraitUseAdaptation_Alias(
        ...
        return (null !== $node->trait ? $this->p($node->trait) . "::" : "") .
            $node->method .
            " as" .
            (null !== $node->newModifier
                ? " " . rtrim($this->pModifiers($node->newModifier), " ")
                : "") .
    ...
    protected function pStmt_Declare(Stmt\Declare_ $node): string {
        return "declare (" .
            $this->pCommaSeparated($node->declares) .
            ")" .
            (null !== $node->stmts
    ...
    protected function pStmt_Case(Stmt\Case_ $node): string {
        return (null !== $node->cond
            ? "case " . $this->p($node->cond)
            : "default") .
            ":" .
            $this->pStmts($node->stmts);
    }
    ...
    protected function pClassCommon(
        Stmt\Class_ $node,
        string $afterClassToken,
    ): string {
    ...
    protected function containsEndLabel(
        ...
        return false !== strpos($string, $label) &&
            preg_match(
                "/" . $start . $label . '(?:$|[^_A-Za-z0-9\x80-\xff])/',
                $string,
            );
    }
        ...
        foreach ($parts as $i => $part) {
            if (
                ...
                $this->containsEndLabel(
                    $this->escapeString($part->value, null),
                    $label,
                    $i === 0,
                )
            ) {
    ...
    protected function pParams(array $params): string {
        if (
            $this->hasNodeWithComments($params) ||
            ($this->hasParamWithAttributes($params) &&
                !$this->phpVersion->supportsAttributes())
        ) {
