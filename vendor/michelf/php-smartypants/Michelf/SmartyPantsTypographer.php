...
class SmartyPantsTypographer extends \Michelf\SmartyPants {
    ...
    protected function spaceFrenchQuotes($_) {
        ...
        $chr =
            $this->do_space_frenchquote != -1 ? $this->space_frenchquote : "";
    ...
    protected function spaceColon($_) {
        ...
        $_ = preg_replace("/$this->space$opt(:)(\\s|$)/m", "$chr\\1\\2", $_);
        return $_;
    }
    ...
    protected function spaceSemicolon($_) {
        ...
        $_ = preg_replace("/$this->space(;)(?=\\s|$)/m", " \\1", $_);
        $_ = preg_replace(
            "/((?:^|\\s)(?>[^&;\\s]+|&#?[a-zA-Z0-9]+;)*)" .
                " $opt(;)(?=\\s|$)/m",
            "\\1$chr\\2",
