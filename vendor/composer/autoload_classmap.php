...
return [
    ...
    "Base32\\Base32Hex" =>
        $vendorDir . "/christian-riesen/base32/src/Base32Hex.php",
    "Bnomei\\Robotstxt" =>
        $baseDir . "/site/plugins/kirby3-robots-txt/classes/Robotstxt.php",
    "Composer\\InstalledVersions" =>
        $vendorDir . "/composer/InstalledVersions.php",
    "Composer\\Semver\\Comparator" =>
        $vendorDir . "/composer/semver/src/Comparator.php",
    "Composer\\Semver\\CompilingMatcher" =>
        $vendorDir . "/composer/semver/src/CompilingMatcher.php",
    "Composer\\Semver\\Constraint\\Bound" =>
        $vendorDir . "/composer/semver/src/Constraint/Bound.php",
    "Composer\\Semver\\Constraint\\Constraint" =>
        $vendorDir . "/composer/semver/src/Constraint/Constraint.php",
    "Composer\\Semver\\Constraint\\ConstraintInterface" =>
        $vendorDir . "/composer/semver/src/Constraint/ConstraintInterface.php",
    "Composer\\Semver\\Constraint\\MatchAllConstraint" =>
        $vendorDir . "/composer/semver/src/Constraint/MatchAllConstraint.php",
    "Composer\\Semver\\Constraint\\MatchNoneConstraint" =>
        $vendorDir . "/composer/semver/src/Constraint/MatchNoneConstraint.php",
    "Composer\\Semver\\Constraint\\MultiConstraint" =>
        $vendorDir . "/composer/semver/src/Constraint/MultiConstraint.php",
    "Composer\\Semver\\Interval" =>
        $vendorDir . "/composer/semver/src/Interval.php",
    "Composer\\Semver\\Intervals" =>
        $vendorDir . "/composer/semver/src/Intervals.php",
    "Composer\\Semver\\Semver" =>
        $vendorDir . "/composer/semver/src/Semver.php",
    "Composer\\Semver\\VersionParser" =>
        $vendorDir . "/composer/semver/src/VersionParser.php",
    "DeepCopy\\DeepCopy" =>
        $vendorDir . "/myclabs/deep-copy/src/DeepCopy/DeepCopy.php",
    ...
    "DeepCopy\\Filter\\Filter" =>
        $vendorDir . "/myclabs/deep-copy/src/DeepCopy/Filter/Filter.php",
    "DeepCopy\\Filter\\KeepFilter" =>
        $vendorDir . "/myclabs/deep-copy/src/DeepCopy/Filter/KeepFilter.php",
    "DeepCopy\\Filter\\ReplaceFilter" =>
        $vendorDir . "/myclabs/deep-copy/src/DeepCopy/Filter/ReplaceFilter.php",
    "DeepCopy\\Filter\\SetNullFilter" =>
        $vendorDir . "/myclabs/deep-copy/src/DeepCopy/Filter/SetNullFilter.php",
    ...
    "DeepCopy\\Matcher\\Matcher" =>
        $vendorDir . "/myclabs/deep-copy/src/DeepCopy/Matcher/Matcher.php",
    ...
    "Ergebnis\\Composer\\Normalize\\Exception\\Exception" =>
        $vendorDir . "/ergebnis/composer-normalize/src/Exception/Exception.php",
    ...
    "Ergebnis\\Composer\\Normalize\\NormalizePlugin" =>
        $vendorDir . "/ergebnis/composer-normalize/src/NormalizePlugin.php",
    "Ergebnis\\Composer\\Normalize\\Version" =>
        $vendorDir . "/ergebnis/composer-normalize/src/Version.php",
    "Ergebnis\\Json\\Exception\\Exception" =>
        $vendorDir . "/ergebnis/json/src/Exception/Exception.php",
    "Ergebnis\\Json\\Exception\\FileCanNotBeRead" =>
        $vendorDir . "/ergebnis/json/src/Exception/FileCanNotBeRead.php",
    "Ergebnis\\Json\\Exception\\FileDoesNotContainJson" =>
        $vendorDir . "/ergebnis/json/src/Exception/FileDoesNotContainJson.php",
    "Ergebnis\\Json\\Exception\\FileDoesNotExist" =>
        $vendorDir . "/ergebnis/json/src/Exception/FileDoesNotExist.php",
    "Ergebnis\\Json\\Exception\\NotJson" =>
        $vendorDir . "/ergebnis/json/src/Exception/NotJson.php",
    "Ergebnis\\Json\\Json" => $vendorDir . "/ergebnis/json/src/Json.php",
    "Ergebnis\\Json\\Normalizer\\CallableNormalizer" =>
        $vendorDir . "/ergebnis/json-normalizer/src/CallableNormalizer.php",
    "Ergebnis\\Json\\Normalizer\\ChainNormalizer" =>
        $vendorDir . "/ergebnis/json-normalizer/src/ChainNormalizer.php",
    ...
    "Ergebnis\\Json\\Normalizer\\Exception\\Exception" =>
        $vendorDir . "/ergebnis/json-normalizer/src/Exception/Exception.php",
    ...
    "Ergebnis\\Json\\Normalizer\\FormatNormalizer" =>
        $vendorDir . "/ergebnis/json-normalizer/src/FormatNormalizer.php",
    ...
    "Ergebnis\\Json\\Normalizer\\Format\\Format" =>
        $vendorDir . "/ergebnis/json-normalizer/src/Format/Format.php",
    "Ergebnis\\Json\\Normalizer\\Format\\Formatter" =>
        $vendorDir . "/ergebnis/json-normalizer/src/Format/Formatter.php",
    "Ergebnis\\Json\\Normalizer\\Format\\Indent" =>
        $vendorDir . "/ergebnis/json-normalizer/src/Format/Indent.php",
    ...
    "Ergebnis\\Json\\Normalizer\\Format\\NewLine" =>
        $vendorDir . "/ergebnis/json-normalizer/src/Format/NewLine.php",
    "Ergebnis\\Json\\Normalizer\\IndentNormalizer" =>
        $vendorDir . "/ergebnis/json-normalizer/src/IndentNormalizer.php",
    "Ergebnis\\Json\\Normalizer\\JsonEncodeNormalizer" =>
        $vendorDir . "/ergebnis/json-normalizer/src/JsonEncodeNormalizer.php",
    "Ergebnis\\Json\\Normalizer\\Normalizer" =>
        $vendorDir . "/ergebnis/json-normalizer/src/Normalizer.php",
    "Ergebnis\\Json\\Normalizer\\SchemaNormalizer" =>
        $vendorDir . "/ergebnis/json-normalizer/src/SchemaNormalizer.php",
    ...
    "Ergebnis\\Json\\Pointer\\Exception\\Exception" =>
        $vendorDir . "/ergebnis/json-pointer/src/Exception/Exception.php",
    ...
    "Ergebnis\\Json\\Pointer\\JsonPointer" =>
        $vendorDir . "/ergebnis/json-pointer/src/JsonPointer.php",
    "Ergebnis\\Json\\Pointer\\Pattern" =>
        $vendorDir . "/ergebnis/json-pointer/src/Pattern.php",
    "Ergebnis\\Json\\Pointer\\ReferenceToken" =>
        $vendorDir . "/ergebnis/json-pointer/src/ReferenceToken.php",
    "Ergebnis\\Json\\Pointer\\Specification" =>
        $vendorDir . "/ergebnis/json-pointer/src/Specification.php",
    "Ergebnis\\Json\\Printer\\Printer" =>
        $vendorDir . "/ergebnis/json-printer/src/Printer.php",
    "Ergebnis\\Json\\Printer\\PrinterInterface" =>
        $vendorDir . "/ergebnis/json-printer/src/PrinterInterface.php",
    ...
    "Ergebnis\\Json\\SchemaValidator\\Message" =>
        $vendorDir . "/ergebnis/json-schema-validator/src/Message.php",
    "Ergebnis\\Json\\SchemaValidator\\SchemaValidator" =>
        $vendorDir . "/ergebnis/json-schema-validator/src/SchemaValidator.php",
    "Ergebnis\\Json\\SchemaValidator\\ValidationError" =>
        $vendorDir . "/ergebnis/json-schema-validator/src/ValidationError.php",
    "Ergebnis\\Json\\SchemaValidator\\ValidationResult" =>
        $vendorDir . "/ergebnis/json-schema-validator/src/ValidationResult.php",
    ...
    "JsonSchema\\Enum" =>
        $vendorDir . "/justinrainbow/json-schema/src/JsonSchema/Enum.php",
    ...
    "JsonSchema\\Rfc3339" =>
        $vendorDir . "/justinrainbow/json-schema/src/JsonSchema/Rfc3339.php",
    ...
    "JsonSchema\\Validator" =>
        $vendorDir . "/justinrainbow/json-schema/src/JsonSchema/Validator.php",
    ...
    "Kirby\\Api\\Controller\\Changes" =>
        $baseDir . "/kirby/src/Api/Controller/Changes.php",
    ...
    "Kirby\\Cache\\MemoryCache" =>
        $baseDir . "/kirby/src/Cache/MemoryCache.php",
    ...
    "Kirby\\Cms\\AppTranslations" =>
        $baseDir . "/kirby/src/Cms/AppTranslations.php",
    ...
    "Kirby\\Cms\\FileBlueprint" =>
        $baseDir . "/kirby/src/Cms/FileBlueprint.php",
    "Kirby\\Cms\\FileModifications" =>
        $baseDir . "/kirby/src/Cms/FileModifications.php",
    "Kirby\\Cms\\FilePermissions" =>
        $baseDir . "/kirby/src/Cms/FilePermissions.php",
    ...
    "Kirby\\Cms\\LanguagePermissions" =>
        $baseDir . "/kirby/src/Cms/LanguagePermissions.php",
    "Kirby\\Cms\\LanguageRouter" =>
        $baseDir . "/kirby/src/Cms/LanguageRouter.php",
    "Kirby\\Cms\\LanguageRoutes" =>
        $baseDir . "/kirby/src/Cms/LanguageRoutes.php",
    "Kirby\\Cms\\LanguageRules" =>
        $baseDir . "/kirby/src/Cms/LanguageRules.php",
    "Kirby\\Cms\\LanguageVariable" =>
        $baseDir . "/kirby/src/Cms/LanguageVariable.php",
    ...
    "Kirby\\Cms\\PageBlueprint" =>
        $baseDir . "/kirby/src/Cms/PageBlueprint.php",
    "Kirby\\Cms\\PageCopy" => $baseDir . "/kirby/src/Cms/PageCopy.php",
    "Kirby\\Cms\\PagePermissions" =>
        $baseDir . "/kirby/src/Cms/PagePermissions.php",
    ...
    "Kirby\\Cms\\SiteBlueprint" =>
        $baseDir . "/kirby/src/Cms/SiteBlueprint.php",
    "Kirby\\Cms\\SitePermissions" =>
        $baseDir . "/kirby/src/Cms/SitePermissions.php",
    ...
    "Kirby\\Cms\\StructureObject" =>
        $baseDir . "/kirby/src/Cms/StructureObject.php",
    "Kirby\\Cms\\System" => $baseDir . "/kirby/src/Cms/System.php",
    "Kirby\\Cms\\System\\UpdateStatus" =>
        $baseDir . "/kirby/src/Cms/System/UpdateStatus.php",
    ...
    "Kirby\\Cms\\UserBlueprint" =>
        $baseDir . "/kirby/src/Cms/UserBlueprint.php",
    "Kirby\\Cms\\UserPermissions" =>
        $baseDir . "/kirby/src/Cms/UserPermissions.php",
    ...
    "Kirby\\Content\\ImmutableMemoryStorage" =>
        $baseDir . "/kirby/src/Content/ImmutableMemoryStorage.php",
    "Kirby\\Content\\Lock" => $baseDir . "/kirby/src/Content/Lock.php",
    "Kirby\\Content\\LockedContentException" =>
        $baseDir . "/kirby/src/Content/LockedContentException.php",
    "Kirby\\Content\\MemoryStorage" =>
        $baseDir . "/kirby/src/Content/MemoryStorage.php",
    "Kirby\\Content\\PlainTextStorage" =>
        $baseDir . "/kirby/src/Content/PlainTextStorage.php",
    "Kirby\\Content\\Storage" => $baseDir . "/kirby/src/Content/Storage.php",
    "Kirby\\Content\\Translation" =>
        $baseDir . "/kirby/src/Content/Translation.php",
    "Kirby\\Content\\Translations" =>
        $baseDir . "/kirby/src/Content/Translations.php",
    "Kirby\\Content\\Version" => $baseDir . "/kirby/src/Content/Version.php",
    "Kirby\\Content\\VersionCache" =>
        $baseDir . "/kirby/src/Content/VersionCache.php",
    "Kirby\\Content\\VersionId" =>
        $baseDir . "/kirby/src/Content/VersionId.php",
    "Kirby\\Content\\VersionRules" =>
        $baseDir . "/kirby/src/Content/VersionRules.php",
    ...
    "Kirby\\Database\\Database" =>
        $baseDir . "/kirby/src/Database/Database.php",
    ...
    "Kirby\\Database\\Sql\\Mysql" =>
        $baseDir . "/kirby/src/Database/Sql/Mysql.php",
    "Kirby\\Database\\Sql\\Sqlite" =>
        $baseDir . "/kirby/src/Database/Sql/Sqlite.php",
    ...
    "Kirby\\Exception\\AuthException" =>
        $baseDir . "/kirby/src/Exception/AuthException.php",
    "Kirby\\Exception\\BadMethodCallException" =>
        $baseDir . "/kirby/src/Exception/BadMethodCallException.php",
    "Kirby\\Exception\\DuplicateException" =>
        $baseDir . "/kirby/src/Exception/DuplicateException.php",
    "Kirby\\Exception\\ErrorPageException" =>
        $baseDir . "/kirby/src/Exception/ErrorPageException.php",
    "Kirby\\Exception\\Exception" =>
        $baseDir . "/kirby/src/Exception/Exception.php",
    "Kirby\\Exception\\InvalidArgumentException" =>
        $baseDir . "/kirby/src/Exception/InvalidArgumentException.php",
    "Kirby\\Exception\\LogicException" =>
        $baseDir . "/kirby/src/Exception/LogicException.php",
    "Kirby\\Exception\\NotFoundException" =>
        $baseDir . "/kirby/src/Exception/NotFoundException.php",
    "Kirby\\Exception\\PermissionException" =>
        $baseDir . "/kirby/src/Exception/PermissionException.php",
    "Kirby\\Field\\FieldOptions" =>
        $baseDir . "/kirby/src/Field/FieldOptions.php",
    ...
    "Kirby\\Filesystem\\Filename" =>
        $baseDir . "/kirby/src/Filesystem/Filename.php",
    "Kirby\\Filesystem\\IsFile" =>
        $baseDir . "/kirby/src/Filesystem/IsFile.php",
    ...
    "Kirby\\Form\\Field\\BlocksField" =>
        $baseDir . "/kirby/src/Form/Field/BlocksField.php",
    "Kirby\\Form\\Field\\EntriesField" =>
        $baseDir . "/kirby/src/Form/Field/EntriesField.php",
    "Kirby\\Form\\Field\\LayoutField" =>
        $baseDir . "/kirby/src/Form/Field/LayoutField.php",
    "Kirby\\Form\\Field\\StatsField" =>
        $baseDir . "/kirby/src/Form/Field/StatsField.php",
    ...
    "Kirby\\Form\\Mixin\\Autofocus" =>
        $baseDir . "/kirby/src/Form/Mixin/Autofocus.php",
    "Kirby\\Form\\Mixin\\Before" =>
        $baseDir . "/kirby/src/Form/Mixin/Before.php",
    "Kirby\\Form\\Mixin\\EmptyState" =>
        $baseDir . "/kirby/src/Form/Mixin/EmptyState.php",
    ...
    "Kirby\\Form\\Mixin\\Placeholder" =>
        $baseDir . "/kirby/src/Form/Mixin/Placeholder.php",
    "Kirby\\Form\\Mixin\\Translatable" =>
        $baseDir . "/kirby/src/Form/Mixin/Translatable.php",
    "Kirby\\Form\\Mixin\\Validation" =>
        $baseDir . "/kirby/src/Form/Mixin/Validation.php",
    ...
    "Kirby\\Http\\Exceptions\\NextRouteException" =>
        $baseDir . "/kirby/src/Http/Exceptions/NextRouteException.php",
    ...
    "Kirby\\Http\\Request\\Auth" =>
        $baseDir . "/kirby/src/Http/Request/Auth.php",
    "Kirby\\Http\\Request\\Auth\\BasicAuth" =>
        $baseDir . "/kirby/src/Http/Request/Auth/BasicAuth.php",
    "Kirby\\Http\\Request\\Auth\\BearerAuth" =>
        $baseDir . "/kirby/src/Http/Request/Auth/BearerAuth.php",
    "Kirby\\Http\\Request\\Auth\\SessionAuth" =>
        $baseDir . "/kirby/src/Http/Request/Auth/SessionAuth.php",
    "Kirby\\Http\\Request\\Body" =>
        $baseDir . "/kirby/src/Http/Request/Body.php",
    "Kirby\\Http\\Request\\Data" =>
        $baseDir . "/kirby/src/Http/Request/Data.php",
    "Kirby\\Http\\Request\\Files" =>
        $baseDir . "/kirby/src/Http/Request/Files.php",
    "Kirby\\Http\\Request\\Query" =>
        $baseDir . "/kirby/src/Http/Request/Query.php",
    ...
    "Kirby\\Http\\VolatileHeaders" =>
        $baseDir . "/kirby/src/Http/VolatileHeaders.php",
    ...
    "Kirby\\Image\\Darkroom\\GdLib" =>
        $baseDir . "/kirby/src/Image/Darkroom/GdLib.php",
    "Kirby\\Image\\Darkroom\\ImageMagick" =>
        $baseDir . "/kirby/src/Image/Darkroom/ImageMagick.php",
    "Kirby\\Image\\Darkroom\\Imagick" =>
        $baseDir . "/kirby/src/Image/Darkroom/Imagick.php",
    ...
    "Kirby\\Option\\OptionsApi" =>
        $baseDir . "/kirby/src/Option/OptionsApi.php",
    "Kirby\\Option\\OptionsProvider" =>
        $baseDir . "/kirby/src/Option/OptionsProvider.php",
    "Kirby\\Option\\OptionsQuery" =>
        $baseDir . "/kirby/src/Option/OptionsQuery.php",
    "Kirby\\Panel\\Assets" => $baseDir . "/kirby/src/Panel/Assets.php",
    "Kirby\\Panel\\ChangesDialog" =>
        $baseDir . "/kirby/src/Panel/ChangesDialog.php",
    "Kirby\\Panel\\Collector\\FilesCollector" =>
        $baseDir . "/kirby/src/Panel/Collector/FilesCollector.php",
    "Kirby\\Panel\\Collector\\ModelsCollector" =>
        $baseDir . "/kirby/src/Panel/Collector/ModelsCollector.php",
    "Kirby\\Panel\\Collector\\PagesCollector" =>
        $baseDir . "/kirby/src/Panel/Collector/PagesCollector.php",
    "Kirby\\Panel\\Collector\\UsersCollector" =>
        $baseDir . "/kirby/src/Panel/Collector/UsersCollector.php",
    "Kirby\\Panel\\Controller\\PageTree" =>
        $baseDir . "/kirby/src/Panel/Controller/PageTree.php",
    "Kirby\\Panel\\Controller\\Search" =>
        $baseDir . "/kirby/src/Panel/Controller/Search.php",
    ...
    "Kirby\\Panel\\Lab\\Category" =>
        $baseDir . "/kirby/src/Panel/Lab/Category.php",
    "Kirby\\Panel\\Lab\\Doc" => $baseDir . "/kirby/src/Panel/Lab/Doc.php",
    "Kirby\\Panel\\Lab\\Doc\\Argument" =>
        $baseDir . "/kirby/src/Panel/Lab/Doc/Argument.php",
    "Kirby\\Panel\\Lab\\Doc\\Event" =>
        $baseDir . "/kirby/src/Panel/Lab/Doc/Event.php",
    "Kirby\\Panel\\Lab\\Doc\\Method" =>
        $baseDir . "/kirby/src/Panel/Lab/Doc/Method.php",
    "Kirby\\Panel\\Lab\\Doc\\Prop" =>
        $baseDir . "/kirby/src/Panel/Lab/Doc/Prop.php",
    "Kirby\\Panel\\Lab\\Doc\\Slot" =>
        $baseDir . "/kirby/src/Panel/Lab/Doc/Slot.php",
    "Kirby\\Panel\\Lab\\Docs" => $baseDir . "/kirby/src/Panel/Lab/Docs.php",
    "Kirby\\Panel\\Lab\\Example" =>
        $baseDir . "/kirby/src/Panel/Lab/Example.php",
    "Kirby\\Panel\\Lab\\Responses" =>
        $baseDir . "/kirby/src/Panel/Lab/Responses.php",
    "Kirby\\Panel\\Lab\\Snippet" =>
        $baseDir . "/kirby/src/Panel/Lab/Snippet.php",
    "Kirby\\Panel\\Lab\\Template" =>
        $baseDir . "/kirby/src/Panel/Lab/Template.php",
    ...
    "Kirby\\Panel\\PageCreateDialog" =>
        $baseDir . "/kirby/src/Panel/PageCreateDialog.php",
    ...
    "Kirby\\Panel\\Ui\\Buttons\\LanguageCreateButton" =>
        $baseDir . "/kirby/src/Panel/Ui/Buttons/LanguageCreateButton.php",
    "Kirby\\Panel\\Ui\\Buttons\\LanguageDeleteButton" =>
        $baseDir . "/kirby/src/Panel/Ui/Buttons/LanguageDeleteButton.php",
    "Kirby\\Panel\\Ui\\Buttons\\LanguageSettingsButton" =>
        $baseDir . "/kirby/src/Panel/Ui/Buttons/LanguageSettingsButton.php",
    "Kirby\\Panel\\Ui\\Buttons\\LanguagesDropdown" =>
        $baseDir . "/kirby/src/Panel/Ui/Buttons/LanguagesDropdown.php",
    "Kirby\\Panel\\Ui\\Buttons\\OpenButton" =>
        $baseDir . "/kirby/src/Panel/Ui/Buttons/OpenButton.php",
    "Kirby\\Panel\\Ui\\Buttons\\PageStatusButton" =>
        $baseDir . "/kirby/src/Panel/Ui/Buttons/PageStatusButton.php",
    "Kirby\\Panel\\Ui\\Buttons\\PreviewButton" =>
        $baseDir . "/kirby/src/Panel/Ui/Buttons/PreviewButton.php",
    "Kirby\\Panel\\Ui\\Buttons\\SettingsButton" =>
        $baseDir . "/kirby/src/Panel/Ui/Buttons/SettingsButton.php",
    "Kirby\\Panel\\Ui\\Buttons\\VersionsButton" =>
        $baseDir . "/kirby/src/Panel/Ui/Buttons/VersionsButton.php",
    "Kirby\\Panel\\Ui\\Buttons\\ViewButton" =>
        $baseDir . "/kirby/src/Panel/Ui/Buttons/ViewButton.php",
    "Kirby\\Panel\\Ui\\Buttons\\ViewButtons" =>
        $baseDir . "/kirby/src/Panel/Ui/Buttons/ViewButtons.php",
    "Kirby\\Panel\\Ui\\Component" =>
        $baseDir . "/kirby/src/Panel/Ui/Component.php",
    "Kirby\\Panel\\Ui\\FilePreview" =>
        $baseDir . "/kirby/src/Panel/Ui/FilePreview.php",
    "Kirby\\Panel\\Ui\\FilePreviews\\AudioFilePreview" =>
        $baseDir . "/kirby/src/Panel/Ui/FilePreviews/AudioFilePreview.php",
    "Kirby\\Panel\\Ui\\FilePreviews\\DefaultFilePreview" =>
        $baseDir . "/kirby/src/Panel/Ui/FilePreviews/DefaultFilePreview.php",
    "Kirby\\Panel\\Ui\\FilePreviews\\ImageFilePreview" =>
        $baseDir . "/kirby/src/Panel/Ui/FilePreviews/ImageFilePreview.php",
    "Kirby\\Panel\\Ui\\FilePreviews\\PdfFilePreview" =>
        $baseDir . "/kirby/src/Panel/Ui/FilePreviews/PdfFilePreview.php",
    "Kirby\\Panel\\Ui\\FilePreviews\\VideoFilePreview" =>
        $baseDir . "/kirby/src/Panel/Ui/FilePreviews/VideoFilePreview.php",
    "Kirby\\Panel\\Ui\\Item\\FileItem" =>
        $baseDir . "/kirby/src/Panel/Ui/Item/FileItem.php",
    "Kirby\\Panel\\Ui\\Item\\ModelItem" =>
        $baseDir . "/kirby/src/Panel/Ui/Item/ModelItem.php",
    "Kirby\\Panel\\Ui\\Item\\PageItem" =>
        $baseDir . "/kirby/src/Panel/Ui/Item/PageItem.php",
    "Kirby\\Panel\\Ui\\Item\\UserItem" =>
        $baseDir . "/kirby/src/Panel/Ui/Item/UserItem.php",
    ...
    "Kirby\\Panel\\UserTotpDisableDialog" =>
        $baseDir . "/kirby/src/Panel/UserTotpDisableDialog.php",
    "Kirby\\Panel\\UserTotpEnableDialog" =>
        $baseDir . "/kirby/src/Panel/UserTotpEnableDialog.php",
    ...
    "Kirby\\Parsley\\Schema\\Blocks" =>
        $baseDir . "/kirby/src/Parsley/Schema/Blocks.php",
    "Kirby\\Parsley\\Schema\\Plain" =>
        $baseDir . "/kirby/src/Parsley/Schema/Plain.php",
    ...
    "Kirby\\Plugin\\LicenseStatus" =>
        $baseDir . "/kirby/src/Plugin/LicenseStatus.php",
    "Kirby\\Plugin\\Plugin" => $baseDir . "/kirby/src/Plugin/Plugin.php",
    "Kirby\\Query\\AST\\ArgumentListNode" =>
        $baseDir . "/kirby/src/Query/AST/ArgumentListNode.php",
    "Kirby\\Query\\AST\\ArithmeticNode" =>
        $baseDir . "/kirby/src/Query/AST/ArithmeticNode.php",
    "Kirby\\Query\\AST\\ArrayListNode" =>
        $baseDir . "/kirby/src/Query/AST/ArrayListNode.php",
    "Kirby\\Query\\AST\\ClosureNode" =>
        $baseDir . "/kirby/src/Query/AST/ClosureNode.php",
    "Kirby\\Query\\AST\\CoalesceNode" =>
        $baseDir . "/kirby/src/Query/AST/CoalesceNode.php",
    "Kirby\\Query\\AST\\ComparisonNode" =>
        $baseDir . "/kirby/src/Query/AST/ComparisonNode.php",
    "Kirby\\Query\\AST\\GlobalFunctionNode" =>
        $baseDir . "/kirby/src/Query/AST/GlobalFunctionNode.php",
    "Kirby\\Query\\AST\\LiteralNode" =>
        $baseDir . "/kirby/src/Query/AST/LiteralNode.php",
    "Kirby\\Query\\AST\\LogicalNode" =>
        $baseDir . "/kirby/src/Query/AST/LogicalNode.php",
    "Kirby\\Query\\AST\\MemberAccessNode" =>
        $baseDir . "/kirby/src/Query/AST/MemberAccessNode.php",
    "Kirby\\Query\\AST\\Node" => $baseDir . "/kirby/src/Query/AST/Node.php",
    "Kirby\\Query\\AST\\TernaryNode" =>
        $baseDir . "/kirby/src/Query/AST/TernaryNode.php",
    "Kirby\\Query\\AST\\VariableNode" =>
        $baseDir . "/kirby/src/Query/AST/VariableNode.php",
    ...
    "Kirby\\Query\\Parser\\Parser" =>
        $baseDir . "/kirby/src/Query/Parser/Parser.php",
    "Kirby\\Query\\Parser\\Token" =>
        $baseDir . "/kirby/src/Query/Parser/Token.php",
    "Kirby\\Query\\Parser\\TokenType" =>
        $baseDir . "/kirby/src/Query/Parser/TokenType.php",
    "Kirby\\Query\\Parser\\Tokenizer" =>
        $baseDir . "/kirby/src/Query/Parser/Tokenizer.php",
    "Kirby\\Query\\Query" => $baseDir . "/kirby/src/Query/Query.php",
    "Kirby\\Query\\Runners\\DefaultRunner" =>
        $baseDir . "/kirby/src/Query/Runners/DefaultRunner.php",
    "Kirby\\Query\\Runners\\Runner" =>
        $baseDir . "/kirby/src/Query/Runners/Runner.php",
    "Kirby\\Query\\Runners\\Scope" =>
        $baseDir . "/kirby/src/Query/Runners/Scope.php",
    ...
    "Kirby\\Query\\Visitors\\DefaultVisitor" =>
        $baseDir . "/kirby/src/Query/Visitors/DefaultVisitor.php",
    "Kirby\\Query\\Visitors\\Visitor" =>
        $baseDir . "/kirby/src/Query/Visitors/Visitor.php",
    "Kirby\\Reflection\\Constructor" =>
        $baseDir . "/kirby/src/Reflection/Constructor.php",
    ...
    "Kirby\\Session\\AutoSession" =>
        $baseDir . "/kirby/src/Session/AutoSession.php",
    "Kirby\\Session\\FileSessionStore" =>
        $baseDir . "/kirby/src/Session/FileSessionStore.php",
    "Kirby\\Session\\Session" => $baseDir . "/kirby/src/Session/Session.php",
    "Kirby\\Session\\SessionData" =>
        $baseDir . "/kirby/src/Session/SessionData.php",
    "Kirby\\Session\\SessionStore" =>
        $baseDir . "/kirby/src/Session/SessionStore.php",
    ...
    "Kirby\\Template\\Template" =>
        $baseDir . "/kirby/src/Template/Template.php",
    ...
    "Kirby\\Toolkit\\Collection" =>
        $baseDir . "/kirby/src/Toolkit/Collection.php",
    "Kirby\\Toolkit\\Component" =>
        $baseDir . "/kirby/src/Toolkit/Component.php",
    "Kirby\\Toolkit\\Config" => $baseDir . "/kirby/src/Toolkit/Config.php",
    "Kirby\\Toolkit\\Controller" =>
        $baseDir . "/kirby/src/Toolkit/Controller.php",
    ...
    "Kirby\\Toolkit\\LazyValue" =>
        $baseDir . "/kirby/src/Toolkit/LazyValue.php",
    ...
    "Kirby\\Toolkit\\Pagination" =>
        $baseDir . "/kirby/src/Toolkit/Pagination.php",
    ...
    "Kirby\\Toolkit\\SymmetricCrypto" =>
        $baseDir . "/kirby/src/Toolkit/SymmetricCrypto.php",
    ...
    "Kirby\\Uuid\\Identifiable" =>
        $baseDir . "/kirby/src/Uuid/Identifiable.php",
    ...
    "Kirby\\Uuid\\StructureUuid" =>
        $baseDir . "/kirby/src/Uuid/StructureUuid.php",
    ...
    "Laminas\\Escaper\\Escaper" =>
        $vendorDir . "/laminas/laminas-escaper/src/Escaper.php",
    "Laminas\\Escaper\\EscaperInterface" =>
        $vendorDir . "/laminas/laminas-escaper/src/EscaperInterface.php",
    ...
    "League\\ColorExtractor\\Color" =>
        $vendorDir . "/league/color-extractor/src/Color.php",
    "League\\ColorExtractor\\ColorExtractor" =>
        $vendorDir . "/league/color-extractor/src/ColorExtractor.php",
    "League\\ColorExtractor\\Palette" =>
        $vendorDir . "/league/color-extractor/src/Palette.php",
    ...
    "Localheinz\\Diff\\Differ" =>
        $vendorDir . "/localheinz/diff/src/Differ.php",
    "Localheinz\\Diff\\Exception" =>
        $vendorDir . "/localheinz/diff/src/Exception/Exception.php",
    ...
    "Localheinz\\Diff\\Output\\DiffOnlyOutputBuilder" =>
        $vendorDir . "/localheinz/diff/src/Output/DiffOnlyOutputBuilder.php",
    ...
    "Localheinz\\Diff\\Output\\UnifiedDiffOutputBuilder" =>
        $vendorDir . "/localheinz/diff/src/Output/UnifiedDiffOutputBuilder.php",
    "Localheinz\\Diff\\Parser" =>
        $vendorDir . "/localheinz/diff/src/Parser.php",
    ...
    "MabeEnum\\EnumSerializableTrait" =>
        $vendorDir . "/marc-mabe/php-enum/src/EnumSerializableTrait.php",
    "MabeEnum\\EnumSet" => $vendorDir . "/marc-mabe/php-enum/src/EnumSet.php",
    "Michelf\\SmartyPants" =>
        $vendorDir . "/michelf/php-smartypants/Michelf/SmartyPants.php",
    ...
    "PHPUnit\\Event\\Code\\ClassMethod" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/ClassMethod.php",
    "PHPUnit\\Event\\Code\\ComparisonFailure" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/ComparisonFailure.php",
    ...
    "PHPUnit\\Event\\Code\\IssueTrigger\\Code" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Test/Issue/Code.php",
    ...
    "PHPUnit\\Event\\Code\\Phpt" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Test/Phpt.php",
    "PHPUnit\\Event\\Code\\Test" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Test/Test.php",
    "PHPUnit\\Event\\Code\\TestCollection" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Test/TestCollection.php",
    ...
    "PHPUnit\\Event\\Code\\TestDox" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Test/TestDox.php",
    "PHPUnit\\Event\\Code\\TestDoxBuilder" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Test/TestDoxBuilder.php",
    "PHPUnit\\Event\\Code\\TestMethod" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Test/TestMethod.php",
    ...
    "PHPUnit\\Event\\Code\\Throwable" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Throwable.php",
    "PHPUnit\\Event\\Code\\ThrowableBuilder" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/ThrowableBuilder.php",
    ...
    "PHPUnit\\Event\\Dispatcher" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Dispatcher/Dispatcher.php",
    "PHPUnit\\Event\\DispatchingEmitter" =>
        $vendorDir .
        "/phpunit/phpunit/src/Event/Emitter/DispatchingEmitter.php",
    "PHPUnit\\Event\\Emitter" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Emitter/Emitter.php",
    "PHPUnit\\Event\\Event" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Events/Event.php",
    ...
    "PHPUnit\\Event\\EventCollection" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Events/EventCollection.php",
    ...
    "PHPUnit\\Event\\Exception" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Exception/Exception.php",
    "PHPUnit\\Event\\Facade" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Facade.php",
    ...
    "PHPUnit\\Event\\MapError" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Exception/MapError.php",
    ...
    "PHPUnit\\Event\\Runtime\\PHP" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Runtime/PHP.php",
    "PHPUnit\\Event\\Runtime\\PHPUnit" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Runtime/PHPUnit.php",
    "PHPUnit\\Event\\Runtime\\Runtime" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Runtime/Runtime.php",
    ...
    "PHPUnit\\Event\\Subscriber" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Subscriber.php",
    ...
    "PHPUnit\\Event\\Telemetry\\Duration" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Telemetry/Duration.php",
    ...
    "PHPUnit\\Event\\Telemetry\\HRTime" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Telemetry/HRTime.php",
    "PHPUnit\\Event\\Telemetry\\Info" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Telemetry/Info.php",
    ...
    "PHPUnit\\Event\\Telemetry\\Snapshot" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Telemetry/Snapshot.php",
    "PHPUnit\\Event\\Telemetry\\StopWatch" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Telemetry/StopWatch.php",
    "PHPUnit\\Event\\Telemetry\\System" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/Telemetry/System.php",
    ...
    "PHPUnit\\Event\\TestRunner\\Started" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Events/TestRunner/Started.php",
    ...
    "PHPUnit\\Event\\TestSuite\\Filtered" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Events/TestSuite/Filtered.php",
    ...
    "PHPUnit\\Event\\TestSuite\\Finished" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Events/TestSuite/Finished.php",
    ...
    "PHPUnit\\Event\\TestSuite\\Loaded" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Events/TestSuite/Loaded.php",
    ...
    "PHPUnit\\Event\\TestSuite\\Skipped" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Events/TestSuite/Skipped.php",
    ...
    "PHPUnit\\Event\\TestSuite\\Sorted" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Events/TestSuite/Sorted.php",
    ...
    "PHPUnit\\Event\\TestSuite\\Started" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Events/TestSuite/Started.php",
    ...
    "PHPUnit\\Event\\TestSuite\\TestSuite" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Value/TestSuite/TestSuite.php",
    ...
    "PHPUnit\\Event\\Tracer\\Tracer" =>
        $vendorDir . "/phpunit/phpunit/src/Event/Tracer.php",
    "PHPUnit\\Event\\TypeMap" =>
        $vendorDir . "/phpunit/phpunit/src/Event/TypeMap.php",
    ...
    "PHPUnit\\Framework\\Assert" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Assert.php",
    "PHPUnit\\Framework\\AssertionFailedError" =>
        $vendorDir .
        "/phpunit/phpunit/src/Framework/Exception/AssertionFailedError.php",
    "PHPUnit\\Framework\\Attributes\\After" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/After.php",
    "PHPUnit\\Framework\\Attributes\\AfterClass" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/AfterClass.php",
    ...
    "PHPUnit\\Framework\\Attributes\\Before" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/Before.php",
    ...
    "PHPUnit\\Framework\\Attributes\\Depends" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/Depends.php",
    ...
    "PHPUnit\\Framework\\Attributes\\Group" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/Group.php",
    ...
    "PHPUnit\\Framework\\Attributes\\Large" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/Large.php",
    "PHPUnit\\Framework\\Attributes\\Medium" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/Medium.php",
    ...
    "PHPUnit\\Framework\\Attributes\\Small" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/Small.php",
    "PHPUnit\\Framework\\Attributes\\Test" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/Test.php",
    "PHPUnit\\Framework\\Attributes\\TestDox" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/TestDox.php",
    "PHPUnit\\Framework\\Attributes\\TestWith" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/TestWith.php",
    ...
    "PHPUnit\\Framework\\Attributes\\Ticket" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/Ticket.php",
    "PHPUnit\\Framework\\Attributes\\UsesClass" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/UsesClass.php",
    ...
    "PHPUnit\\Framework\\Attributes\\UsesMethod" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/UsesMethod.php",
    "PHPUnit\\Framework\\Attributes\\UsesTrait" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Attributes/UsesTrait.php",
    ...
    "PHPUnit\\Framework\\Constraint\\Callback" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Constraint/Callback.php",
    "PHPUnit\\Framework\\Constraint\\Constraint" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Constraint/Constraint.php",
    ...
    "PHPUnit\\Framework\\Constraint\\IsAnything" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Constraint/IsAnything.php",
    ...
    "PHPUnit\\Framework\\Constraint\\IsNan" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Constraint/Math/IsNan.php",
    ...
    "PHPUnit\\Framework\\DataProviderTestSuite" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/DataProviderTestSuite.php",
    "PHPUnit\\Framework\\EmptyStringException" =>
        $vendorDir .
        "/phpunit/phpunit/src/Framework/Exception/EmptyStringException.php",
    "PHPUnit\\Framework\\Exception" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Exception/Exception.php",
    ...
    "PHPUnit\\Framework\\NativeType" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/NativeType.php",
    ...
    "PHPUnit\\Framework\\Reorderable" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Reorderable.php",
    "PHPUnit\\Framework\\SelfDescribing" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/SelfDescribing.php",
    ...
    "PHPUnit\\Framework\\Test" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/Test.php",
    "PHPUnit\\Framework\\TestBuilder" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestBuilder.php",
    "PHPUnit\\Framework\\TestCase" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestCase.php",
    "PHPUnit\\Framework\\TestRunner" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestRunner/TestRunner.php",
    "PHPUnit\\Framework\\TestSize\\Known" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestSize/Known.php",
    "PHPUnit\\Framework\\TestSize\\Large" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestSize/Large.php",
    "PHPUnit\\Framework\\TestSize\\Medium" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestSize/Medium.php",
    "PHPUnit\\Framework\\TestSize\\Small" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestSize/Small.php",
    "PHPUnit\\Framework\\TestSize\\TestSize" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestSize/TestSize.php",
    "PHPUnit\\Framework\\TestSize\\Unknown" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestSize/Unknown.php",
    ...
    "PHPUnit\\Framework\\TestStatus\\Error" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestStatus/Error.php",
    "PHPUnit\\Framework\\TestStatus\\Failure" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestStatus/Failure.php",
    "PHPUnit\\Framework\\TestStatus\\Incomplete" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestStatus/Incomplete.php",
    "PHPUnit\\Framework\\TestStatus\\Known" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestStatus/Known.php",
    "PHPUnit\\Framework\\TestStatus\\Notice" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestStatus/Notice.php",
    "PHPUnit\\Framework\\TestStatus\\Risky" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestStatus/Risky.php",
    "PHPUnit\\Framework\\TestStatus\\Skipped" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestStatus/Skipped.php",
    "PHPUnit\\Framework\\TestStatus\\Success" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestStatus/Success.php",
    "PHPUnit\\Framework\\TestStatus\\TestStatus" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestStatus/TestStatus.php",
    "PHPUnit\\Framework\\TestStatus\\Unknown" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestStatus/Unknown.php",
    "PHPUnit\\Framework\\TestStatus\\Warning" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestStatus/Warning.php",
    "PHPUnit\\Framework\\TestSuite" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestSuite.php",
    "PHPUnit\\Framework\\TestSuiteIterator" =>
        $vendorDir . "/phpunit/phpunit/src/Framework/TestSuiteIterator.php",
    ...
    "PHPUnit\\Logging\\EventLogger" =>
        $vendorDir . "/phpunit/phpunit/src/Logging/EventLogger.php",
    "PHPUnit\\Logging\\JUnit\\JunitXmlLogger" =>
        $vendorDir . "/phpunit/phpunit/src/Logging/JUnit/JunitXmlLogger.php",
    ...
    "PHPUnit\\Logging\\TeamCity\\TeamCityLogger" =>
        $vendorDir . "/phpunit/phpunit/src/Logging/TeamCity/TeamCityLogger.php",
    ...
    "PHPUnit\\Logging\\TestDox\\HtmlRenderer" =>
        $vendorDir . "/phpunit/phpunit/src/Logging/TestDox/HtmlRenderer.php",
    "PHPUnit\\Logging\\TestDox\\NamePrettifier" =>
        $vendorDir . "/phpunit/phpunit/src/Logging/TestDox/NamePrettifier.php",
    ...
    "PHPUnit\\Metadata\\After" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/After.php",
    "PHPUnit\\Metadata\\AfterClass" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/AfterClass.php",
    ...
    "PHPUnit\\Metadata\\Api\\CodeCoverage" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Api/CodeCoverage.php",
    "PHPUnit\\Metadata\\Api\\DataProvider" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Api/DataProvider.php",
    "PHPUnit\\Metadata\\Api\\Dependencies" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Api/Dependencies.php",
    "PHPUnit\\Metadata\\Api\\Groups" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Api/Groups.php",
    "PHPUnit\\Metadata\\Api\\HookMethods" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Api/HookMethods.php",
    "PHPUnit\\Metadata\\Api\\Requirements" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Api/Requirements.php",
    "PHPUnit\\Metadata\\BackupGlobals" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/BackupGlobals.php",
    "PHPUnit\\Metadata\\BackupStaticProperties" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/BackupStaticProperties.php",
    "PHPUnit\\Metadata\\Before" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Before.php",
    "PHPUnit\\Metadata\\BeforeClass" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/BeforeClass.php",
    "PHPUnit\\Metadata\\Covers" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Covers.php",
    "PHPUnit\\Metadata\\CoversClass" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/CoversClass.php",
    "PHPUnit\\Metadata\\CoversDefaultClass" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/CoversDefaultClass.php",
    "PHPUnit\\Metadata\\CoversFunction" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/CoversFunction.php",
    "PHPUnit\\Metadata\\CoversMethod" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/CoversMethod.php",
    "PHPUnit\\Metadata\\CoversNothing" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/CoversNothing.php",
    "PHPUnit\\Metadata\\CoversTrait" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/CoversTrait.php",
    "PHPUnit\\Metadata\\DataProvider" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/DataProvider.php",
    "PHPUnit\\Metadata\\DependsOnClass" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/DependsOnClass.php",
    "PHPUnit\\Metadata\\DependsOnMethod" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/DependsOnMethod.php",
    ...
    "PHPUnit\\Metadata\\Exception" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Exception/Exception.php",
    ...
    "PHPUnit\\Metadata\\Group" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Group.php",
    "PHPUnit\\Metadata\\IgnoreDeprecations" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/IgnoreDeprecations.php",
    ...
    "PHPUnit\\Metadata\\Metadata" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Metadata.php",
    "PHPUnit\\Metadata\\MetadataCollection" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/MetadataCollection.php",
    ...
    "PHPUnit\\Metadata\\Parser\\AttributeParser" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Parser/AttributeParser.php",
    "PHPUnit\\Metadata\\Parser\\CachingParser" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Parser/CachingParser.php",
    "PHPUnit\\Metadata\\Parser\\Parser" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Parser/Parser.php",
    "PHPUnit\\Metadata\\Parser\\ParserChain" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Parser/ParserChain.php",
    "PHPUnit\\Metadata\\Parser\\Registry" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Parser/Registry.php",
    "PHPUnit\\Metadata\\PostCondition" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/PostCondition.php",
    "PHPUnit\\Metadata\\PreCondition" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/PreCondition.php",
    "PHPUnit\\Metadata\\PreserveGlobalState" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/PreserveGlobalState.php",
    ...
    "PHPUnit\\Metadata\\RequiresFunction" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/RequiresFunction.php",
    "PHPUnit\\Metadata\\RequiresMethod" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/RequiresMethod.php",
    ...
    "PHPUnit\\Metadata\\RequiresPhp" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/RequiresPhp.php",
    "PHPUnit\\Metadata\\RequiresPhpExtension" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/RequiresPhpExtension.php",
    "PHPUnit\\Metadata\\RequiresPhpunit" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/RequiresPhpunit.php",
    ...
    "PHPUnit\\Metadata\\RequiresSetting" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/RequiresSetting.php",
    ...
    "PHPUnit\\Metadata\\RunInSeparateProcess" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/RunInSeparateProcess.php",
    ...
    "PHPUnit\\Metadata\\Test" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Test.php",
    "PHPUnit\\Metadata\\TestDox" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/TestDox.php",
    "PHPUnit\\Metadata\\TestWith" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/TestWith.php",
    "PHPUnit\\Metadata\\Uses" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Uses.php",
    "PHPUnit\\Metadata\\UsesClass" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/UsesClass.php",
    "PHPUnit\\Metadata\\UsesDefaultClass" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/UsesDefaultClass.php",
    "PHPUnit\\Metadata\\UsesFunction" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/UsesFunction.php",
    "PHPUnit\\Metadata\\UsesMethod" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/UsesMethod.php",
    "PHPUnit\\Metadata\\UsesTrait" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/UsesTrait.php",
    ...
    "PHPUnit\\Metadata\\Version\\Requirement" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/Version/Requirement.php",
    "PHPUnit\\Metadata\\WithoutErrorHandler" =>
        $vendorDir . "/phpunit/phpunit/src/Metadata/WithoutErrorHandler.php",
    "PHPUnit\\Runner\\Baseline\\Baseline" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/Baseline/Baseline.php",
    ...
    "PHPUnit\\Runner\\Baseline\\Generator" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/Baseline/Generator.php",
    "PHPUnit\\Runner\\Baseline\\Issue" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/Baseline/Issue.php",
    "PHPUnit\\Runner\\Baseline\\Reader" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/Baseline/Reader.php",
    ...
    "PHPUnit\\Runner\\Baseline\\Writer" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/Baseline/Writer.php",
    ...
    "PHPUnit\\Runner\\CodeCoverage" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/CodeCoverage.php",
    ...
    "PHPUnit\\Runner\\ErrorException" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/Exception/ErrorException.php",
    "PHPUnit\\Runner\\ErrorHandler" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/ErrorHandler.php",
    "PHPUnit\\Runner\\Exception" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/Exception/Exception.php",
    "PHPUnit\\Runner\\Extension\\Extension" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/Extension/Extension.php",
    ...
    "PHPUnit\\Runner\\Extension\\Facade" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/Extension/Facade.php",
    ...
    "PHPUnit\\Runner\\Extension\\PharLoader" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/Extension/PharLoader.php",
    ...
    "PHPUnit\\Runner\\Filter\\Factory" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/Filter/Factory.php",
    ...
    "PHPUnit\\Runner\\HookMethod" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/HookMethod/HookMethod.php",
    ...
    "PHPUnit\\Runner\\PhptTestCase" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/PHPT/PhptTestCase.php",
    ...
    "PHPUnit\\Runner\\ResultCache\\ResultCache" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/ResultCache/ResultCache.php",
    ...
    "PHPUnit\\Runner\\TestSuiteLoader" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/TestSuiteLoader.php",
    "PHPUnit\\Runner\\TestSuiteSorter" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/TestSuiteSorter.php",
    ...
    "PHPUnit\\Runner\\Version" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/Version.php",
    "PHPUnit\\TestRunner\\IssueFilter" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/IssueFilter.php",
    ...
    "PHPUnit\\TestRunner\\TestResult\\Collector" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/TestResult/Collector.php",
    ...
    "PHPUnit\\TestRunner\\TestResult\\Facade" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/TestResult/Facade.php",
    "PHPUnit\\TestRunner\\TestResult\\Issues\\Issue" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/TestResult/Issue.php",
    "PHPUnit\\TestRunner\\TestResult\\PassedTests" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/TestResult/PassedTests.php",
    ...
    "PHPUnit\\TestRunner\\TestResult\\TestResult" =>
        $vendorDir . "/phpunit/phpunit/src/Runner/TestResult/TestResult.php",
    ...
    "PHPUnit\\TextUI\\Application" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Application.php",
    ...
    "PHPUnit\\TextUI\\Command\\Command" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Command/Command.php",
    ...
    "PHPUnit\\TextUI\\Command\\Result" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Command/Result.php",
    ...
    "PHPUnit\\TextUI\\Configuration\\Builder" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Configuration/Builder.php",
    ...
    "PHPUnit\\TextUI\\Configuration\\File" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Configuration/Value/File.php",
    ...
    "PHPUnit\\TextUI\\Configuration\\Merger" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Configuration/Merger.php",
    ...
    "PHPUnit\\TextUI\\Configuration\\Php" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Configuration/Value/Php.php",
    "PHPUnit\\TextUI\\Configuration\\PhpHandler" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Configuration/PhpHandler.php",
    "PHPUnit\\TextUI\\Configuration\\Registry" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Configuration/Registry.php",
    ...
    "PHPUnit\\TextUI\\Exception" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Exception/Exception.php",
    "PHPUnit\\TextUI\\Help" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Help.php",
    ...
    "PHPUnit\\TextUI\\Output\\Facade" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Output/Facade.php",
    "PHPUnit\\TextUI\\Output\\NullPrinter" =>
        $vendorDir .
        "/phpunit/phpunit/src/TextUI/Output/Printer/NullPrinter.php",
    "PHPUnit\\TextUI\\Output\\Printer" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Output/Printer/Printer.php",
    "PHPUnit\\TextUI\\Output\\SummaryPrinter" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Output/SummaryPrinter.php",
    ...
    "PHPUnit\\TextUI\\ShellExitCodeCalculator" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/ShellExitCodeCalculator.php",
    ...
    "PHPUnit\\TextUI\\TestRunner" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/TestRunner.php",
    "PHPUnit\\TextUI\\TestSuiteFilterProcessor" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/TestSuiteFilterProcessor.php",
    ...
    "PHPUnit\\TextUI\\XmlConfiguration\\Groups" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Configuration/Xml/Groups.php",
    ...
    "PHPUnit\\TextUI\\XmlConfiguration\\Loader" =>
        $vendorDir . "/phpunit/phpunit/src/TextUI/Configuration/Xml/Loader.php",
    ...
    "PHPUnit\\Util\\Cloner" =>
        $vendorDir . "/phpunit/phpunit/src/Util/Cloner.php",
    "PHPUnit\\Util\\Color" =>
        $vendorDir . "/phpunit/phpunit/src/Util/Color.php",
    "PHPUnit\\Util\\Exception" =>
        $vendorDir . "/phpunit/phpunit/src/Util/Exception/Exception.php",
    "PHPUnit\\Util\\ExcludeList" =>
        $vendorDir . "/phpunit/phpunit/src/Util/ExcludeList.php",
    "PHPUnit\\Util\\Exporter" =>
        $vendorDir . "/phpunit/phpunit/src/Util/Exporter.php",
    "PHPUnit\\Util\\Filesystem" =>
        $vendorDir . "/phpunit/phpunit/src/Util/Filesystem.php",
    "PHPUnit\\Util\\Filter" =>
        $vendorDir . "/phpunit/phpunit/src/Util/Filter.php",
    "PHPUnit\\Util\\GlobalState" =>
        $vendorDir . "/phpunit/phpunit/src/Util/GlobalState.php",
    "PHPUnit\\Util\\Http\\Downloader" =>
        $vendorDir . "/phpunit/phpunit/src/Util/Http/Downloader.php",
    "PHPUnit\\Util\\Http\\PhpDownloader" =>
        $vendorDir . "/phpunit/phpunit/src/Util/Http/PhpDownloader.php",
    ...
    "PHPUnit\\Util\\PHP\\DefaultJobRunner" =>
        $vendorDir . "/phpunit/phpunit/src/Util/PHP/DefaultJobRunner.php",
    "PHPUnit\\Util\\PHP\\Job" =>
        $vendorDir . "/phpunit/phpunit/src/Util/PHP/Job.php",
    "PHPUnit\\Util\\PHP\\JobRunner" =>
        $vendorDir . "/phpunit/phpunit/src/Util/PHP/JobRunner.php",
    "PHPUnit\\Util\\PHP\\JobRunnerRegistry" =>
        $vendorDir . "/phpunit/phpunit/src/Util/PHP/JobRunnerRegistry.php",
    "PHPUnit\\Util\\PHP\\PhpProcessException" =>
        $vendorDir .
        "/phpunit/phpunit/src/Util/Exception/PhpProcessException.php",
    "PHPUnit\\Util\\PHP\\Result" =>
        $vendorDir . "/phpunit/phpunit/src/Util/PHP/Result.php",
    "PHPUnit\\Util\\Reflection" =>
        $vendorDir . "/phpunit/phpunit/src/Util/Reflection.php",
    "PHPUnit\\Util\\Test" => $vendorDir . "/phpunit/phpunit/src/Util/Test.php",
    "PHPUnit\\Util\\ThrowableToStringMapper" =>
        $vendorDir . "/phpunit/phpunit/src/Util/ThrowableToStringMapper.php",
    "PHPUnit\\Util\\VersionComparisonOperator" =>
        $vendorDir . "/phpunit/phpunit/src/Util/VersionComparisonOperator.php",
    "PHPUnit\\Util\\Xml" =>
        $vendorDir . "/phpunit/phpunit/src/Util/Xml/Xml.php",
    "PHPUnit\\Util\\Xml\\Loader" =>
        $vendorDir . "/phpunit/phpunit/src/Util/Xml/Loader.php",
    "PHPUnit\\Util\\Xml\\XmlException" =>
        $vendorDir . "/phpunit/phpunit/src/Util/Exception/XmlException.php",
    "Parsedown" => $baseDir . "/kirby/dependencies/parsedown/Parsedown.php",
    "ParsedownExtra" =>
        $baseDir . "/kirby/dependencies/parsedown-extra/ParsedownExtra.php",
    "PharIo\\Manifest\\Application" =>
        $vendorDir . "/phar-io/manifest/src/values/Application.php",
    "PharIo\\Manifest\\ApplicationName" =>
        $vendorDir . "/phar-io/manifest/src/values/ApplicationName.php",
    "PharIo\\Manifest\\Author" =>
        $vendorDir . "/phar-io/manifest/src/values/Author.php",
    "PharIo\\Manifest\\AuthorCollection" =>
        $vendorDir . "/phar-io/manifest/src/values/AuthorCollection.php",
    ...
    "PharIo\\Manifest\\AuthorElement" =>
        $vendorDir . "/phar-io/manifest/src/xml/AuthorElement.php",
    "PharIo\\Manifest\\AuthorElementCollection" =>
        $vendorDir . "/phar-io/manifest/src/xml/AuthorElementCollection.php",
    "PharIo\\Manifest\\BundledComponent" =>
        $vendorDir . "/phar-io/manifest/src/values/BundledComponent.php",
    ...
    "PharIo\\Manifest\\BundlesElement" =>
        $vendorDir . "/phar-io/manifest/src/xml/BundlesElement.php",
    "PharIo\\Manifest\\ComponentElement" =>
        $vendorDir . "/phar-io/manifest/src/xml/ComponentElement.php",
    "PharIo\\Manifest\\ComponentElementCollection" =>
        $vendorDir . "/phar-io/manifest/src/xml/ComponentElementCollection.php",
    "PharIo\\Manifest\\ContainsElement" =>
        $vendorDir . "/phar-io/manifest/src/xml/ContainsElement.php",
    "PharIo\\Manifest\\CopyrightElement" =>
        $vendorDir . "/phar-io/manifest/src/xml/CopyrightElement.php",
    "PharIo\\Manifest\\CopyrightInformation" =>
        $vendorDir . "/phar-io/manifest/src/values/CopyrightInformation.php",
    "PharIo\\Manifest\\ElementCollection" =>
        $vendorDir . "/phar-io/manifest/src/xml/ElementCollection.php",
    ...
    "PharIo\\Manifest\\Email" =>
        $vendorDir . "/phar-io/manifest/src/values/Email.php",
    "PharIo\\Manifest\\Exception" =>
        $vendorDir . "/phar-io/manifest/src/exceptions/Exception.php",
    "PharIo\\Manifest\\ExtElement" =>
        $vendorDir . "/phar-io/manifest/src/xml/ExtElement.php",
    "PharIo\\Manifest\\ExtElementCollection" =>
        $vendorDir . "/phar-io/manifest/src/xml/ExtElementCollection.php",
    "PharIo\\Manifest\\Extension" =>
        $vendorDir . "/phar-io/manifest/src/values/Extension.php",
    "PharIo\\Manifest\\ExtensionElement" =>
        $vendorDir . "/phar-io/manifest/src/xml/ExtensionElement.php",
    ...
    "PharIo\\Manifest\\InvalidUrlException" =>
        $vendorDir . "/phar-io/manifest/src/exceptions/InvalidUrlException.php",
    "PharIo\\Manifest\\Library" =>
        $vendorDir . "/phar-io/manifest/src/values/Library.php",
    "PharIo\\Manifest\\License" =>
        $vendorDir . "/phar-io/manifest/src/values/License.php",
    "PharIo\\Manifest\\LicenseElement" =>
        $vendorDir . "/phar-io/manifest/src/xml/LicenseElement.php",
    "PharIo\\Manifest\\Manifest" =>
        $vendorDir . "/phar-io/manifest/src/values/Manifest.php",
    "PharIo\\Manifest\\ManifestDocument" =>
        $vendorDir . "/phar-io/manifest/src/xml/ManifestDocument.php",
    ...
    "PharIo\\Manifest\\ManifestDocumentMapper" =>
        $vendorDir . "/phar-io/manifest/src/ManifestDocumentMapper.php",
    ...
    "PharIo\\Manifest\\ManifestElement" =>
        $vendorDir . "/phar-io/manifest/src/xml/ManifestElement.php",
    ...
    "PharIo\\Manifest\\ManifestLoader" =>
        $vendorDir . "/phar-io/manifest/src/ManifestLoader.php",
    ...
    "PharIo\\Manifest\\ManifestSerializer" =>
        $vendorDir . "/phar-io/manifest/src/ManifestSerializer.php",
    ...
    "PharIo\\Manifest\\PhpElement" =>
        $vendorDir . "/phar-io/manifest/src/xml/PhpElement.php",
    "PharIo\\Manifest\\PhpExtensionRequirement" =>
        $vendorDir . "/phar-io/manifest/src/values/PhpExtensionRequirement.php",
    "PharIo\\Manifest\\PhpVersionRequirement" =>
        $vendorDir . "/phar-io/manifest/src/values/PhpVersionRequirement.php",
    "PharIo\\Manifest\\Requirement" =>
        $vendorDir . "/phar-io/manifest/src/values/Requirement.php",
    "PharIo\\Manifest\\RequirementCollection" =>
        $vendorDir . "/phar-io/manifest/src/values/RequirementCollection.php",
    ...
    "PharIo\\Manifest\\RequiresElement" =>
        $vendorDir . "/phar-io/manifest/src/xml/RequiresElement.php",
    "PharIo\\Manifest\\Type" =>
        $vendorDir . "/phar-io/manifest/src/values/Type.php",
    "PharIo\\Manifest\\Url" =>
        $vendorDir . "/phar-io/manifest/src/values/Url.php",
    ...
    "PharIo\\Version\\PreReleaseSuffix" =>
        $vendorDir . "/phar-io/version/src/PreReleaseSuffix.php",
    ...
    "PharIo\\Version\\Version" =>
        $vendorDir . "/phar-io/version/src/Version.php",
    "PharIo\\Version\\VersionConstraint" =>
        $vendorDir . "/phar-io/version/src/constraints/VersionConstraint.php",
    "PharIo\\Version\\VersionConstraintParser" =>
        $vendorDir . "/phar-io/version/src/VersionConstraintParser.php",
    "PharIo\\Version\\VersionConstraintValue" =>
        $vendorDir . "/phar-io/version/src/VersionConstraintValue.php",
    "PharIo\\Version\\VersionNumber" =>
        $vendorDir . "/phar-io/version/src/VersionNumber.php",
    "Phiki\\CommonMark\\CodeBlockRenderer" =>
        $vendorDir . "/phiki/phiki/src/CommonMark/CodeBlockRenderer.php",
    "Phiki\\CommonMark\\PhikiExtension" =>
        $vendorDir . "/phiki/phiki/src/CommonMark/PhikiExtension.php",
    "Phiki\\Contracts\\ContainsCapturesInterface" =>
        $vendorDir . "/phiki/phiki/src/Contracts/ContainsCapturesInterface.php",
    "Phiki\\Contracts\\ExtensionInterface" =>
        $vendorDir . "/phiki/phiki/src/Contracts/ExtensionInterface.php",
    ...
    "Phiki\\Contracts\\InjectionMatcherInterface" =>
        $vendorDir . "/phiki/phiki/src/Contracts/InjectionMatcherInterface.php",
    ...
    "Phiki\\Contracts\\OutputGeneratorInterface" =>
        $vendorDir . "/phiki/phiki/src/Contracts/OutputGeneratorInterface.php",
    ...
    "Phiki\\Contracts\\PatternInterface" =>
        $vendorDir . "/phiki/phiki/src/Contracts/PatternInterface.php",
    "Phiki\\Contracts\\ProvidesContentName" =>
        $vendorDir . "/phiki/phiki/src/Contracts/ProvidesContentName.php",
    "Phiki\\Contracts\\ThemeRepositoryInterface" =>
        $vendorDir . "/phiki/phiki/src/Contracts/ThemeRepositoryInterface.php",
    "Phiki\\Environment\\Environment" =>
        $vendorDir . "/phiki/phiki/src/Environment/Environment.php",
    "Phiki\\Exceptions\\EnvironmentException" =>
        $vendorDir . "/phiki/phiki/src/Exceptions/EnvironmentException.php",
    ...
    "Phiki\\Exceptions\\UnreachableException" =>
        $vendorDir . "/phiki/phiki/src/Exceptions/UnreachableException.php",
    ...
    "Phiki\\Extensions\\DefaultExtension" =>
        $vendorDir . "/phiki/phiki/src/Extensions/DefaultExtension.php",
    "Phiki\\Generators\\HtmlGenerator" =>
        $vendorDir . "/phiki/phiki/src/Generators/HtmlGenerator.php",
    "Phiki\\Generators\\TerminalGenerator" =>
        $vendorDir . "/phiki/phiki/src/Generators/TerminalGenerator.php",
    "Phiki\\Grammar\\BeginEndPattern" =>
        $vendorDir . "/phiki/phiki/src/Grammar/BeginEndPattern.php",
    "Phiki\\Grammar\\BeginWhilePattern" =>
        $vendorDir . "/phiki/phiki/src/Grammar/BeginWhilePattern.php",
    "Phiki\\Grammar\\Capture" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Capture.php",
    "Phiki\\Grammar\\CollectionPattern" =>
        $vendorDir . "/phiki/phiki/src/Grammar/CollectionPattern.php",
    "Phiki\\Grammar\\DefaultGrammars" =>
        $vendorDir . "/phiki/phiki/src/Grammar/DefaultGrammars.php",
    "Phiki\\Grammar\\EndPattern" =>
        $vendorDir . "/phiki/phiki/src/Grammar/EndPattern.php",
    "Phiki\\Grammar\\Grammar" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Grammar.php",
    "Phiki\\Grammar\\GrammarRepository" =>
        $vendorDir . "/phiki/phiki/src/Grammar/GrammarRepository.php",
    "Phiki\\Grammar\\IncludePattern" =>
        $vendorDir . "/phiki/phiki/src/Grammar/IncludePattern.php",
    "Phiki\\Grammar\\Injections\\Composite" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Injections/Composite.php",
    "Phiki\\Grammar\\Injections\\Expression" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Injections/Expression.php",
    "Phiki\\Grammar\\Injections\\Filter" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Injections/Filter.php",
    "Phiki\\Grammar\\Injections\\Group" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Injections/Group.php",
    "Phiki\\Grammar\\Injections\\Injection" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Injections/Injection.php",
    "Phiki\\Grammar\\Injections\\Operator" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Injections/Operator.php",
    "Phiki\\Grammar\\Injections\\Path" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Injections/Path.php",
    "Phiki\\Grammar\\Injections\\Prefix" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Injections/Prefix.php",
    "Phiki\\Grammar\\Injections\\Scope" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Injections/Scope.php",
    "Phiki\\Grammar\\Injections\\Selector" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Injections/Selector.php",
    "Phiki\\Grammar\\MatchPattern" =>
        $vendorDir . "/phiki/phiki/src/Grammar/MatchPattern.php",
    "Phiki\\Grammar\\MatchedPattern" =>
        $vendorDir . "/phiki/phiki/src/Grammar/MatchedPattern.php",
    "Phiki\\Grammar\\ParsedGrammar" =>
        $vendorDir . "/phiki/phiki/src/Grammar/ParsedGrammar.php",
    "Phiki\\Grammar\\Parser" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Parser.php",
    "Phiki\\Grammar\\Pattern" =>
        $vendorDir . "/phiki/phiki/src/Grammar/Pattern.php",
    "Phiki\\Grammar\\WhilePattern" =>
        $vendorDir . "/phiki/phiki/src/Grammar/WhilePattern.php",
    ...
    "Phiki\\Support\\Color" =>
        $vendorDir . "/phiki/phiki/src/Support/Color.php",
    "Phiki\\Support\\Regex" =>
        $vendorDir . "/phiki/phiki/src/Support/Regex.php",
    "Phiki\\Support\\Str" => $vendorDir . "/phiki/phiki/src/Support/Str.php",
    "Phiki\\Theme\\DefaultThemes" =>
        $vendorDir . "/phiki/phiki/src/Theme/DefaultThemes.php",
    "Phiki\\Theme\\ParsedTheme" =>
        $vendorDir . "/phiki/phiki/src/Theme/ParsedTheme.php",
    ...
    "Phiki\\Theme\\ThemeRepository" =>
        $vendorDir . "/phiki/phiki/src/Theme/ThemeRepository.php",
    "Phiki\\Theme\\ThemeStyles" =>
        $vendorDir . "/phiki/phiki/src/Theme/ThemeStyles.php",
    "Phiki\\Theme\\TokenColor" =>
        $vendorDir . "/phiki/phiki/src/Theme/TokenColor.php",
    "Phiki\\Theme\\TokenSettings" =>
        $vendorDir . "/phiki/phiki/src/Theme/TokenSettings.php",
    "Phiki\\Token\\HighlightedToken" =>
        $vendorDir . "/phiki/phiki/src/Token/HighlightedToken.php",
    "Phiki\\Token\\Token" => $vendorDir . "/phiki/phiki/src/Token/Token.php",
    "Phiki\\Tokenizer" => $vendorDir . "/phiki/phiki/src/Tokenizer.php",
    "PhpParser\\Builder" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder.php",
    "PhpParser\\BuilderFactory" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/BuilderFactory.php",
    "PhpParser\\BuilderHelpers" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/BuilderHelpers.php",
    "PhpParser\\Builder\\ClassConst" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/ClassConst.php",
    "PhpParser\\Builder\\Class_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/Class_.php",
    "PhpParser\\Builder\\Declaration" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/Declaration.php",
    "PhpParser\\Builder\\EnumCase" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/EnumCase.php",
    "PhpParser\\Builder\\Enum_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/Enum_.php",
    "PhpParser\\Builder\\FunctionLike" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/FunctionLike.php",
    "PhpParser\\Builder\\Function_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/Function_.php",
    "PhpParser\\Builder\\Interface_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/Interface_.php",
    "PhpParser\\Builder\\Method" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/Method.php",
    "PhpParser\\Builder\\Namespace_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/Namespace_.php",
    "PhpParser\\Builder\\Param" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/Param.php",
    "PhpParser\\Builder\\Property" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/Property.php",
    "PhpParser\\Builder\\TraitUse" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/TraitUse.php",
    "PhpParser\\Builder\\TraitUseAdaptation" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Builder/TraitUseAdaptation.php",
    "PhpParser\\Builder\\Trait_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/Trait_.php",
    "PhpParser\\Builder\\Use_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Builder/Use_.php",
    "PhpParser\\Comment" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Comment.php",
    "PhpParser\\Comment\\Doc" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Comment/Doc.php",
    ...
    "PhpParser\\ConstExprEvaluator" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/ConstExprEvaluator.php",
    "PhpParser\\Error" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Error.php",
    "PhpParser\\ErrorHandler" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/ErrorHandler.php",
    ...
    "PhpParser\\Internal\\DiffElem" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Internal/DiffElem.php",
    "PhpParser\\Internal\\Differ" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Internal/Differ.php",
    ...
    "PhpParser\\Internal\\TokenStream" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Internal/TokenStream.php",
    "PhpParser\\JsonDecoder" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/JsonDecoder.php",
    "PhpParser\\Lexer" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Lexer.php",
    "PhpParser\\Lexer\\Emulative" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Lexer/Emulative.php",
    ...
    "PhpParser\\Modifiers" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Modifiers.php",
    "PhpParser\\NameContext" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/NameContext.php",
    "PhpParser\\Node" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node.php",
    "PhpParser\\NodeAbstract" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/NodeAbstract.php",
    "PhpParser\\NodeDumper" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/NodeDumper.php",
    "PhpParser\\NodeFinder" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/NodeFinder.php",
    "PhpParser\\NodeTraverser" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/NodeTraverser.php",
    "PhpParser\\NodeTraverserInterface" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/NodeTraverserInterface.php",
    "PhpParser\\NodeVisitor" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/NodeVisitor.php",
    "PhpParser\\NodeVisitorAbstract" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/NodeVisitorAbstract.php",
    ...
    "PhpParser\\Node\\Arg" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Arg.php",
    "PhpParser\\Node\\ArrayItem" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/ArrayItem.php",
    "PhpParser\\Node\\Attribute" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Attribute.php",
    "PhpParser\\Node\\AttributeGroup" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/AttributeGroup.php",
    "PhpParser\\Node\\ClosureUse" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/ClosureUse.php",
    "PhpParser\\Node\\ComplexType" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/ComplexType.php",
    "PhpParser\\Node\\Const_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Const_.php",
    "PhpParser\\Node\\DeclareItem" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/DeclareItem.php",
    "PhpParser\\Node\\Expr" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr.php",
    ...
    "PhpParser\\Node\\Expr\\Array_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Array_.php",
    "PhpParser\\Node\\Expr\\ArrowFunction" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Node/Expr/ArrowFunction.php",
    "PhpParser\\Node\\Expr\\Assign" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Assign.php",
    "PhpParser\\Node\\Expr\\AssignOp" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/AssignOp.php",
    ...
    "PhpParser\\Node\\Expr\\AssignRef" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/AssignRef.php",
    "PhpParser\\Node\\Expr\\BinaryOp" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/BinaryOp.php",
    ...
    "PhpParser\\Node\\Expr\\BitwiseNot" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/BitwiseNot.php",
    "PhpParser\\Node\\Expr\\BooleanNot" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/BooleanNot.php",
    "PhpParser\\Node\\Expr\\CallLike" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/CallLike.php",
    "PhpParser\\Node\\Expr\\Cast" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Cast.php",
    "PhpParser\\Node\\Expr\\Cast\\Array_" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Node/Expr/Cast/Array_.php",
    "PhpParser\\Node\\Expr\\Cast\\Bool_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Cast/Bool_.php",
    "PhpParser\\Node\\Expr\\Cast\\Double" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Node/Expr/Cast/Double.php",
    "PhpParser\\Node\\Expr\\Cast\\Int_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Cast/Int_.php",
    ...
    "PhpParser\\Node\\Expr\\Cast\\Void_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Cast/Void_.php",
    "PhpParser\\Node\\Expr\\ClassConstFetch" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Node/Expr/ClassConstFetch.php",
    "PhpParser\\Node\\Expr\\Clone_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Clone_.php",
    "PhpParser\\Node\\Expr\\Closure" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Closure.php",
    "PhpParser\\Node\\Expr\\ClosureUse" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/ClosureUse.php",
    "PhpParser\\Node\\Expr\\ConstFetch" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/ConstFetch.php",
    "PhpParser\\Node\\Expr\\Empty_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Empty_.php",
    "PhpParser\\Node\\Expr\\Error" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Error.php",
    "PhpParser\\Node\\Expr\\ErrorSuppress" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Node/Expr/ErrorSuppress.php",
    "PhpParser\\Node\\Expr\\Eval_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Eval_.php",
    "PhpParser\\Node\\Expr\\Exit_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Exit_.php",
    "PhpParser\\Node\\Expr\\FuncCall" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/FuncCall.php",
    "PhpParser\\Node\\Expr\\Include_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Include_.php",
    "PhpParser\\Node\\Expr\\Instanceof_" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Node/Expr/Instanceof_.php",
    "PhpParser\\Node\\Expr\\Isset_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Isset_.php",
    "PhpParser\\Node\\Expr\\List_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/List_.php",
    "PhpParser\\Node\\Expr\\Match_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Match_.php",
    "PhpParser\\Node\\Expr\\MethodCall" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/MethodCall.php",
    "PhpParser\\Node\\Expr\\New_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/New_.php",
    ...
    "PhpParser\\Node\\Expr\\PostDec" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/PostDec.php",
    "PhpParser\\Node\\Expr\\PostInc" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/PostInc.php",
    "PhpParser\\Node\\Expr\\PreDec" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/PreDec.php",
    "PhpParser\\Node\\Expr\\PreInc" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/PreInc.php",
    "PhpParser\\Node\\Expr\\Print_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Print_.php",
    "PhpParser\\Node\\Expr\\PropertyFetch" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Node/Expr/PropertyFetch.php",
    "PhpParser\\Node\\Expr\\ShellExec" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/ShellExec.php",
    "PhpParser\\Node\\Expr\\StaticCall" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/StaticCall.php",
    "PhpParser\\Node\\Expr\\StaticPropertyFetch" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Node/Expr/StaticPropertyFetch.php",
    "PhpParser\\Node\\Expr\\Ternary" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Ternary.php",
    "PhpParser\\Node\\Expr\\Throw_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Throw_.php",
    "PhpParser\\Node\\Expr\\UnaryMinus" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/UnaryMinus.php",
    "PhpParser\\Node\\Expr\\UnaryPlus" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/UnaryPlus.php",
    "PhpParser\\Node\\Expr\\Variable" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Variable.php",
    "PhpParser\\Node\\Expr\\YieldFrom" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/YieldFrom.php",
    "PhpParser\\Node\\Expr\\Yield_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Expr/Yield_.php",
    "PhpParser\\Node\\FunctionLike" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/FunctionLike.php",
    "PhpParser\\Node\\Identifier" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Identifier.php",
    ...
    "PhpParser\\Node\\MatchArm" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/MatchArm.php",
    "PhpParser\\Node\\Name" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Name.php",
    ...
    "PhpParser\\Node\\Name\\Relative" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Name/Relative.php",
    "PhpParser\\Node\\NullableType" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/NullableType.php",
    "PhpParser\\Node\\Param" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Param.php",
    "PhpParser\\Node\\PropertyHook" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/PropertyHook.php",
    "PhpParser\\Node\\PropertyItem" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/PropertyItem.php",
    "PhpParser\\Node\\Scalar" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Scalar.php",
    ...
    "PhpParser\\Node\\Scalar\\Float_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Scalar/Float_.php",
    "PhpParser\\Node\\Scalar\\Int_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Scalar/Int_.php",
    ...
    "PhpParser\\Node\\Scalar\\String_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Scalar/String_.php",
    "PhpParser\\Node\\StaticVar" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/StaticVar.php",
    "PhpParser\\Node\\Stmt" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt.php",
    "PhpParser\\Node\\Stmt\\Block" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Block.php",
    "PhpParser\\Node\\Stmt\\Break_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Break_.php",
    "PhpParser\\Node\\Stmt\\Case_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Case_.php",
    "PhpParser\\Node\\Stmt\\Catch_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Catch_.php",
    "PhpParser\\Node\\Stmt\\ClassConst" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/ClassConst.php",
    "PhpParser\\Node\\Stmt\\ClassLike" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/ClassLike.php",
    "PhpParser\\Node\\Stmt\\ClassMethod" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Node/Stmt/ClassMethod.php",
    "PhpParser\\Node\\Stmt\\Class_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Class_.php",
    "PhpParser\\Node\\Stmt\\Const_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Const_.php",
    "PhpParser\\Node\\Stmt\\Continue_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Continue_.php",
    "PhpParser\\Node\\Stmt\\DeclareDeclare" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Node/Stmt/DeclareDeclare.php",
    "PhpParser\\Node\\Stmt\\Declare_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Declare_.php",
    "PhpParser\\Node\\Stmt\\Do_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Do_.php",
    "PhpParser\\Node\\Stmt\\Echo_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Echo_.php",
    "PhpParser\\Node\\Stmt\\ElseIf_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/ElseIf_.php",
    "PhpParser\\Node\\Stmt\\Else_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Else_.php",
    "PhpParser\\Node\\Stmt\\EnumCase" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/EnumCase.php",
    "PhpParser\\Node\\Stmt\\Enum_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Enum_.php",
    "PhpParser\\Node\\Stmt\\Expression" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Expression.php",
    "PhpParser\\Node\\Stmt\\Finally_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Finally_.php",
    "PhpParser\\Node\\Stmt\\For_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/For_.php",
    "PhpParser\\Node\\Stmt\\Foreach_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Foreach_.php",
    "PhpParser\\Node\\Stmt\\Function_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Function_.php",
    "PhpParser\\Node\\Stmt\\Global_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Global_.php",
    "PhpParser\\Node\\Stmt\\Goto_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Goto_.php",
    "PhpParser\\Node\\Stmt\\GroupUse" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/GroupUse.php",
    "PhpParser\\Node\\Stmt\\HaltCompiler" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Node/Stmt/HaltCompiler.php",
    "PhpParser\\Node\\Stmt\\If_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/If_.php",
    "PhpParser\\Node\\Stmt\\InlineHTML" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/InlineHTML.php",
    "PhpParser\\Node\\Stmt\\Interface_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Interface_.php",
    "PhpParser\\Node\\Stmt\\Label" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Label.php",
    "PhpParser\\Node\\Stmt\\Namespace_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Namespace_.php",
    "PhpParser\\Node\\Stmt\\Nop" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Nop.php",
    "PhpParser\\Node\\Stmt\\Property" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Property.php",
    "PhpParser\\Node\\Stmt\\PropertyProperty" =>
        $vendorDir .
        "/nikic/php-parser/lib/PhpParser/Node/Stmt/PropertyProperty.php",
    "PhpParser\\Node\\Stmt\\Return_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Return_.php",
    "PhpParser\\Node\\Stmt\\StaticVar" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/StaticVar.php",
    "PhpParser\\Node\\Stmt\\Static_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Static_.php",
    "PhpParser\\Node\\Stmt\\Switch_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Switch_.php",
    "PhpParser\\Node\\Stmt\\TraitUse" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/TraitUse.php",
    ...
    "PhpParser\\Node\\Stmt\\Trait_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Trait_.php",
    "PhpParser\\Node\\Stmt\\TryCatch" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/TryCatch.php",
    "PhpParser\\Node\\Stmt\\Unset_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Unset_.php",
    "PhpParser\\Node\\Stmt\\UseUse" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/UseUse.php",
    "PhpParser\\Node\\Stmt\\Use_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/Use_.php",
    "PhpParser\\Node\\Stmt\\While_" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/Stmt/While_.php",
    "PhpParser\\Node\\UnionType" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/UnionType.php",
    "PhpParser\\Node\\UseItem" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Node/UseItem.php",
    ...
    "PhpParser\\Parser" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Parser.php",
    "PhpParser\\ParserAbstract" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/ParserAbstract.php",
    "PhpParser\\ParserFactory" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/ParserFactory.php",
    "PhpParser\\Parser\\Php7" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Parser/Php7.php",
    "PhpParser\\Parser\\Php8" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Parser/Php8.php",
    "PhpParser\\PhpVersion" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/PhpVersion.php",
    "PhpParser\\PrettyPrinter" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/PrettyPrinter.php",
    ...
    "PhpParser\\Token" =>
        $vendorDir . "/nikic/php-parser/lib/PhpParser/Token.php",
    "Psr\\Log\\AbstractLogger" =>
        $vendorDir . "/psr/log/src/AbstractLogger.php",
    "Psr\\Log\\InvalidArgumentException" =>
        $vendorDir . "/psr/log/src/InvalidArgumentException.php",
    "Psr\\Log\\LogLevel" => $vendorDir . "/psr/log/src/LogLevel.php",
    "Psr\\Log\\LoggerAwareInterface" =>
        $vendorDir . "/psr/log/src/LoggerAwareInterface.php",
    "Psr\\Log\\LoggerAwareTrait" =>
        $vendorDir . "/psr/log/src/LoggerAwareTrait.php",
    "Psr\\Log\\LoggerInterface" =>
        $vendorDir . "/psr/log/src/LoggerInterface.php",
    ...
    "SebastianBergmann\\CliParser\\Exception" =>
        $vendorDir . "/sebastian/cli-parser/src/exceptions/Exception.php",
    ...
    "SebastianBergmann\\CliParser\\Parser" =>
        $vendorDir . "/sebastian/cli-parser/src/Parser.php",
    ...
    "SebastianBergmann\\CodeCoverage\\CodeCoverage" =>
        $vendorDir . "/phpunit/php-code-coverage/src/CodeCoverage.php",
    ...
    "SebastianBergmann\\CodeCoverage\\Driver\\Driver" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Driver/Driver.php",
    ...
    "SebastianBergmann\\CodeCoverage\\Driver\\PcovDriver" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Driver/PcovDriver.php",
    ...
    "SebastianBergmann\\CodeCoverage\\Driver\\Selector" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Driver/Selector.php",
    ...
    'SebastianBergmann\\CodeCoverage\\Driver\\XdebugDriver' =>
        $vendorDir . "/phpunit/php-code-coverage/src/Driver/XdebugDriver.php",
    ...
    "SebastianBergmann\\CodeCoverage\\Exception" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Exception/Exception.php",
    ...
    "SebastianBergmann\\CodeCoverage\\Filter" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Filter.php",
    ...
    "SebastianBergmann\\CodeCoverage\\Node\\AbstractNode" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Node/AbstractNode.php",
    "SebastianBergmann\\CodeCoverage\\Node\\Builder" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Node/Builder.php",
    "SebastianBergmann\\CodeCoverage\\Node\\CrapIndex" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Node/CrapIndex.php",
    "SebastianBergmann\\CodeCoverage\\Node\\Directory" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Node/Directory.php",
    "SebastianBergmann\\CodeCoverage\\Node\\File" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Node/File.php",
    "SebastianBergmann\\CodeCoverage\\Node\\Iterator" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Node/Iterator.php",
    ...
    "SebastianBergmann\\CodeCoverage\\Report\\Clover" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Clover.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Cobertura" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Cobertura.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Crap4j" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Crap4j.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Html\\Colors" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Html/Colors.php",
    ...
    "SebastianBergmann\\CodeCoverage\\Report\\Html\\Facade" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Html/Facade.php",
    ...
    "SebastianBergmann\\CodeCoverage\\Report\\Html\\Renderer" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Html/Renderer.php",
    "SebastianBergmann\\CodeCoverage\\Report\\PHP" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/PHP.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Text" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Text.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Thresholds" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Thresholds.php",
    ...
    "SebastianBergmann\\CodeCoverage\\Report\\Xml\\Coverage" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Xml/Coverage.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Xml\\Directory" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Xml/Directory.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Xml\\Facade" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Xml/Facade.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Xml\\File" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Xml/File.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Xml\\Method" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Xml/Method.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Xml\\Node" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Xml/Node.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Xml\\Project" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Xml/Project.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Xml\\Report" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Xml/Report.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Xml\\Source" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Xml/Source.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Xml\\Tests" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Xml/Tests.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Xml\\Totals" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Xml/Totals.php",
    "SebastianBergmann\\CodeCoverage\\Report\\Xml\\Unit" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Report/Xml/Unit.php",
    ...
    "SebastianBergmann\\CodeCoverage\\Test\\TestSize\\Known" =>
        $vendorDir . "/phpunit/php-code-coverage/src/TestSize/Known.php",
    "SebastianBergmann\\CodeCoverage\\Test\\TestSize\\Large" =>
        $vendorDir . "/phpunit/php-code-coverage/src/TestSize/Large.php",
    "SebastianBergmann\\CodeCoverage\\Test\\TestSize\\Medium" =>
        $vendorDir . "/phpunit/php-code-coverage/src/TestSize/Medium.php",
    "SebastianBergmann\\CodeCoverage\\Test\\TestSize\\Small" =>
        $vendorDir . "/phpunit/php-code-coverage/src/TestSize/Small.php",
    "SebastianBergmann\\CodeCoverage\\Test\\TestSize\\TestSize" =>
        $vendorDir . "/phpunit/php-code-coverage/src/TestSize/TestSize.php",
    "SebastianBergmann\\CodeCoverage\\Test\\TestSize\\Unknown" =>
        $vendorDir . "/phpunit/php-code-coverage/src/TestSize/Unknown.php",
    "SebastianBergmann\\CodeCoverage\\Test\\TestStatus\\Failure" =>
        $vendorDir . "/phpunit/php-code-coverage/src/TestStatus/Failure.php",
    "SebastianBergmann\\CodeCoverage\\Test\\TestStatus\\Known" =>
        $vendorDir . "/phpunit/php-code-coverage/src/TestStatus/Known.php",
    "SebastianBergmann\\CodeCoverage\\Test\\TestStatus\\Success" =>
        $vendorDir . "/phpunit/php-code-coverage/src/TestStatus/Success.php",
    "SebastianBergmann\\CodeCoverage\\Test\\TestStatus\\TestStatus" =>
        $vendorDir . "/phpunit/php-code-coverage/src/TestStatus/TestStatus.php",
    "SebastianBergmann\\CodeCoverage\\Test\\TestStatus\\Unknown" =>
        $vendorDir . "/phpunit/php-code-coverage/src/TestStatus/Unknown.php",
    ...
    "SebastianBergmann\\CodeCoverage\\Util\\Filesystem" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Util/Filesystem.php",
    "SebastianBergmann\\CodeCoverage\\Util\\Percentage" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Util/Percentage.php",
    "SebastianBergmann\\CodeCoverage\\Util\\Xml" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Util/Xml.php",
    "SebastianBergmann\\CodeCoverage\\Version" =>
        $vendorDir . "/phpunit/php-code-coverage/src/Version.php",
    ...
    "SebastianBergmann\\CodeUnitReverseLookup\\Wizard" =>
        $vendorDir . "/sebastian/code-unit-reverse-lookup/src/Wizard.php",
    "SebastianBergmann\\CodeUnit\\ClassMethodUnit" =>
        $vendorDir . "/sebastian/code-unit/src/ClassMethodUnit.php",
    "SebastianBergmann\\CodeUnit\\ClassUnit" =>
        $vendorDir . "/sebastian/code-unit/src/ClassUnit.php",
    "SebastianBergmann\\CodeUnit\\CodeUnit" =>
        $vendorDir . "/sebastian/code-unit/src/CodeUnit.php",
    "SebastianBergmann\\CodeUnit\\CodeUnitCollection" =>
        $vendorDir . "/sebastian/code-unit/src/CodeUnitCollection.php",
    "SebastianBergmann\\CodeUnit\\CodeUnitCollectionIterator" =>
        $vendorDir . "/sebastian/code-unit/src/CodeUnitCollectionIterator.php",
    "SebastianBergmann\\CodeUnit\\Exception" =>
        $vendorDir . "/sebastian/code-unit/src/exceptions/Exception.php",
    "SebastianBergmann\\CodeUnit\\FileUnit" =>
        $vendorDir . "/sebastian/code-unit/src/FileUnit.php",
    "SebastianBergmann\\CodeUnit\\FunctionUnit" =>
        $vendorDir . "/sebastian/code-unit/src/FunctionUnit.php",
    "SebastianBergmann\\CodeUnit\\InterfaceMethodUnit" =>
        $vendorDir . "/sebastian/code-unit/src/InterfaceMethodUnit.php",
    "SebastianBergmann\\CodeUnit\\InterfaceUnit" =>
        $vendorDir . "/sebastian/code-unit/src/InterfaceUnit.php",
    ...
    "SebastianBergmann\\CodeUnit\\Mapper" =>
        $vendorDir . "/sebastian/code-unit/src/Mapper.php",
    "SebastianBergmann\\CodeUnit\\NoTraitException" =>
        $vendorDir . "/sebastian/code-unit/src/exceptions/NoTraitException.php",
    ...
    "SebastianBergmann\\CodeUnit\\TraitMethodUnit" =>
        $vendorDir . "/sebastian/code-unit/src/TraitMethodUnit.php",
    "SebastianBergmann\\CodeUnit\\TraitUnit" =>
        $vendorDir . "/sebastian/code-unit/src/TraitUnit.php",
    "SebastianBergmann\\Comparator\\ArrayComparator" =>
        $vendorDir . "/sebastian/comparator/src/ArrayComparator.php",
    "SebastianBergmann\\Comparator\\Comparator" =>
        $vendorDir . "/sebastian/comparator/src/Comparator.php",
    "SebastianBergmann\\Comparator\\ComparisonFailure" =>
        $vendorDir . "/sebastian/comparator/src/ComparisonFailure.php",
    "SebastianBergmann\\Comparator\\DOMNodeComparator" =>
        $vendorDir . "/sebastian/comparator/src/DOMNodeComparator.php",
    "SebastianBergmann\\Comparator\\DateTimeComparator" =>
        $vendorDir . "/sebastian/comparator/src/DateTimeComparator.php",
    "SebastianBergmann\\Comparator\\EnumerationComparator" =>
        $vendorDir . "/sebastian/comparator/src/EnumerationComparator.php",
    "SebastianBergmann\\Comparator\\Exception" =>
        $vendorDir . "/sebastian/comparator/src/exceptions/Exception.php",
    "SebastianBergmann\\Comparator\\ExceptionComparator" =>
        $vendorDir . "/sebastian/comparator/src/ExceptionComparator.php",
    "SebastianBergmann\\Comparator\\Factory" =>
        $vendorDir . "/sebastian/comparator/src/Factory.php",
    "SebastianBergmann\\Comparator\\MockObjectComparator" =>
        $vendorDir . "/sebastian/comparator/src/MockObjectComparator.php",
    "SebastianBergmann\\Comparator\\NumberComparator" =>
        $vendorDir . "/sebastian/comparator/src/NumberComparator.php",
    "SebastianBergmann\\Comparator\\NumericComparator" =>
        $vendorDir . "/sebastian/comparator/src/NumericComparator.php",
    "SebastianBergmann\\Comparator\\ObjectComparator" =>
        $vendorDir . "/sebastian/comparator/src/ObjectComparator.php",
    "SebastianBergmann\\Comparator\\ResourceComparator" =>
        $vendorDir . "/sebastian/comparator/src/ResourceComparator.php",
    ...
    "SebastianBergmann\\Comparator\\ScalarComparator" =>
        $vendorDir . "/sebastian/comparator/src/ScalarComparator.php",
    "SebastianBergmann\\Comparator\\SplObjectStorageComparator" =>
        $vendorDir . "/sebastian/comparator/src/SplObjectStorageComparator.php",
    "SebastianBergmann\\Comparator\\TypeComparator" =>
        $vendorDir . "/sebastian/comparator/src/TypeComparator.php",
    "SebastianBergmann\\Complexity\\Calculator" =>
        $vendorDir . "/sebastian/complexity/src/Calculator.php",
    "SebastianBergmann\\Complexity\\Complexity" =>
        $vendorDir . "/sebastian/complexity/src/Complexity/Complexity.php",
    ...
    "SebastianBergmann\\Complexity\\Exception" =>
        $vendorDir . "/sebastian/complexity/src/Exception/Exception.php",
    "SebastianBergmann\\Complexity\\RuntimeException" =>
        $vendorDir . "/sebastian/complexity/src/Exception/RuntimeException.php",
    "SebastianBergmann\\Diff\\Chunk" =>
        $vendorDir . "/sebastian/diff/src/Chunk.php",
    "SebastianBergmann\\Diff\\ConfigurationException" =>
        $vendorDir . "/sebastian/diff/src/Exception/ConfigurationException.php",
    "SebastianBergmann\\Diff\\Diff" =>
        $vendorDir . "/sebastian/diff/src/Diff.php",
    "SebastianBergmann\\Diff\\Differ" =>
        $vendorDir . "/sebastian/diff/src/Differ.php",
    "SebastianBergmann\\Diff\\Exception" =>
        $vendorDir . "/sebastian/diff/src/Exception/Exception.php",
    ...
    "SebastianBergmann\\Diff\\Line" =>
        $vendorDir . "/sebastian/diff/src/Line.php",
    ...
    "SebastianBergmann\\Diff\\Output\\DiffOnlyOutputBuilder" =>
        $vendorDir . "/sebastian/diff/src/Output/DiffOnlyOutputBuilder.php",
    ...
    "SebastianBergmann\\Diff\\Output\\UnifiedDiffOutputBuilder" =>
        $vendorDir . "/sebastian/diff/src/Output/UnifiedDiffOutputBuilder.php",
    "SebastianBergmann\\Diff\\Parser" =>
        $vendorDir . "/sebastian/diff/src/Parser.php",
    ...
    "SebastianBergmann\\Environment\\Console" =>
        $vendorDir . "/sebastian/environment/src/Console.php",
    "SebastianBergmann\\Environment\\Runtime" =>
        $vendorDir . "/sebastian/environment/src/Runtime.php",
    "SebastianBergmann\\Exporter\\Exporter" =>
        $vendorDir . "/sebastian/exporter/src/Exporter.php",
    "SebastianBergmann\\FileIterator\\ExcludeIterator" =>
        $vendorDir . "/phpunit/php-file-iterator/src/ExcludeIterator.php",
    "SebastianBergmann\\FileIterator\\Facade" =>
        $vendorDir . "/phpunit/php-file-iterator/src/Facade.php",
    ...
    "SebastianBergmann\\GlobalState\\CodeExporter" =>
        $vendorDir . "/sebastian/global-state/src/CodeExporter.php",
    "SebastianBergmann\\GlobalState\\Exception" =>
        $vendorDir . "/sebastian/global-state/src/exceptions/Exception.php",
    "SebastianBergmann\\GlobalState\\ExcludeList" =>
        $vendorDir . "/sebastian/global-state/src/ExcludeList.php",
    "SebastianBergmann\\GlobalState\\Restorer" =>
        $vendorDir . "/sebastian/global-state/src/Restorer.php",
    ...
    "SebastianBergmann\\GlobalState\\Snapshot" =>
        $vendorDir . "/sebastian/global-state/src/Snapshot.php",
    "SebastianBergmann\\Invoker\\Exception" =>
        $vendorDir . "/phpunit/php-invoker/src/exceptions/Exception.php",
    "SebastianBergmann\\Invoker\\Invoker" =>
        $vendorDir . "/phpunit/php-invoker/src/Invoker.php",
    ...
    "SebastianBergmann\\Invoker\\TimeoutException" =>
        $vendorDir . "/phpunit/php-invoker/src/exceptions/TimeoutException.php",
    "SebastianBergmann\\LinesOfCode\\Counter" =>
        $vendorDir . "/sebastian/lines-of-code/src/Counter.php",
    "SebastianBergmann\\LinesOfCode\\Exception" =>
        $vendorDir . "/sebastian/lines-of-code/src/Exception/Exception.php",
    ...
    "SebastianBergmann\\LinesOfCode\\LineCountingVisitor" =>
        $vendorDir . "/sebastian/lines-of-code/src/LineCountingVisitor.php",
    "SebastianBergmann\\LinesOfCode\\LinesOfCode" =>
        $vendorDir . "/sebastian/lines-of-code/src/LinesOfCode.php",
    ...
    "SebastianBergmann\\ObjectEnumerator\\Enumerator" =>
        $vendorDir . "/sebastian/object-enumerator/src/Enumerator.php",
    "SebastianBergmann\\ObjectReflector\\ObjectReflector" =>
        $vendorDir . "/sebastian/object-reflector/src/ObjectReflector.php",
    "SebastianBergmann\\RecursionContext\\Context" =>
        $vendorDir . "/sebastian/recursion-context/src/Context.php",
    "SebastianBergmann\\Template\\Exception" =>
        $vendorDir . "/phpunit/php-text-template/src/exceptions/Exception.php",
    ...
    "SebastianBergmann\\Template\\Template" =>
        $vendorDir . "/phpunit/php-text-template/src/Template.php",
    "SebastianBergmann\\Timer\\Duration" =>
        $vendorDir . "/phpunit/php-timer/src/Duration.php",
    "SebastianBergmann\\Timer\\Exception" =>
        $vendorDir . "/phpunit/php-timer/src/exceptions/Exception.php",
    ...
    "SebastianBergmann\\Timer\\ResourceUsageFormatter" =>
        $vendorDir . "/phpunit/php-timer/src/ResourceUsageFormatter.php",
    ...
    "SebastianBergmann\\Timer\\Timer" =>
        $vendorDir . "/phpunit/php-timer/src/Timer.php",
    "SebastianBergmann\\Type\\CallableType" =>
        $vendorDir . "/sebastian/type/src/type/CallableType.php",
    "SebastianBergmann\\Type\\Exception" =>
        $vendorDir . "/sebastian/type/src/exception/Exception.php",
    "SebastianBergmann\\Type\\FalseType" =>
        $vendorDir . "/sebastian/type/src/type/FalseType.php",
    "SebastianBergmann\\Type\\GenericObjectType" =>
        $vendorDir . "/sebastian/type/src/type/GenericObjectType.php",
    "SebastianBergmann\\Type\\IntersectionType" =>
        $vendorDir . "/sebastian/type/src/type/IntersectionType.php",
    "SebastianBergmann\\Type\\IterableType" =>
        $vendorDir . "/sebastian/type/src/type/IterableType.php",
    "SebastianBergmann\\Type\\MixedType" =>
        $vendorDir . "/sebastian/type/src/type/MixedType.php",
    "SebastianBergmann\\Type\\NeverType" =>
        $vendorDir . "/sebastian/type/src/type/NeverType.php",
    "SebastianBergmann\\Type\\NullType" =>
        $vendorDir . "/sebastian/type/src/type/NullType.php",
    "SebastianBergmann\\Type\\ObjectType" =>
        $vendorDir . "/sebastian/type/src/type/ObjectType.php",
    "SebastianBergmann\\Type\\Parameter" =>
        $vendorDir . "/sebastian/type/src/Parameter.php",
    "SebastianBergmann\\Type\\ReflectionMapper" =>
        $vendorDir . "/sebastian/type/src/ReflectionMapper.php",
    "SebastianBergmann\\Type\\RuntimeException" =>
        $vendorDir . "/sebastian/type/src/exception/RuntimeException.php",
    "SebastianBergmann\\Type\\SimpleType" =>
        $vendorDir . "/sebastian/type/src/type/SimpleType.php",
    "SebastianBergmann\\Type\\StaticType" =>
        $vendorDir . "/sebastian/type/src/type/StaticType.php",
    "SebastianBergmann\\Type\\TrueType" =>
        $vendorDir . "/sebastian/type/src/type/TrueType.php",
    "SebastianBergmann\\Type\\Type" =>
        $vendorDir . "/sebastian/type/src/type/Type.php",
    "SebastianBergmann\\Type\\TypeName" =>
        $vendorDir . "/sebastian/type/src/TypeName.php",
    "SebastianBergmann\\Type\\UnionType" =>
        $vendorDir . "/sebastian/type/src/type/UnionType.php",
    "SebastianBergmann\\Type\\UnknownType" =>
        $vendorDir . "/sebastian/type/src/type/UnknownType.php",
    "SebastianBergmann\\Type\\VoidType" =>
        $vendorDir . "/sebastian/type/src/type/VoidType.php",
    "SebastianBergmann\\Version" =>
        $vendorDir . "/sebastian/version/src/Version.php",
    ...
    "Symfony\\Component\\CssSelector\\CssSelectorConverter" =>
        $vendorDir . "/symfony/css-selector/CssSelectorConverter.php",
    "Symfony\\Component\\CssSelector\\Exception\\ExceptionInterface" =>
        $vendorDir . "/symfony/css-selector/Exception/ExceptionInterface.php",
    ...
    "Symfony\\Component\\CssSelector\\Exception\\ParseException" =>
        $vendorDir . "/symfony/css-selector/Exception/ParseException.php",
    "Symfony\\Component\\CssSelector\\Exception\\SyntaxErrorException" =>
        $vendorDir . "/symfony/css-selector/Exception/SyntaxErrorException.php",
    "Symfony\\Component\\CssSelector\\Node\\AbstractNode" =>
        $vendorDir . "/symfony/css-selector/Node/AbstractNode.php",
    "Symfony\\Component\\CssSelector\\Node\\AttributeNode" =>
        $vendorDir . "/symfony/css-selector/Node/AttributeNode.php",
    "Symfony\\Component\\CssSelector\\Node\\ClassNode" =>
        $vendorDir . "/symfony/css-selector/Node/ClassNode.php",
    "Symfony\\Component\\CssSelector\\Node\\CombinedSelectorNode" =>
        $vendorDir . "/symfony/css-selector/Node/CombinedSelectorNode.php",
    "Symfony\\Component\\CssSelector\\Node\\ElementNode" =>
        $vendorDir . "/symfony/css-selector/Node/ElementNode.php",
    "Symfony\\Component\\CssSelector\\Node\\FunctionNode" =>
        $vendorDir . "/symfony/css-selector/Node/FunctionNode.php",
    "Symfony\\Component\\CssSelector\\Node\\HashNode" =>
        $vendorDir . "/symfony/css-selector/Node/HashNode.php",
    "Symfony\\Component\\CssSelector\\Node\\MatchingNode" =>
        $vendorDir . "/symfony/css-selector/Node/MatchingNode.php",
    "Symfony\\Component\\CssSelector\\Node\\NegationNode" =>
        $vendorDir . "/symfony/css-selector/Node/NegationNode.php",
    "Symfony\\Component\\CssSelector\\Node\\NodeInterface" =>
        $vendorDir . "/symfony/css-selector/Node/NodeInterface.php",
    "Symfony\\Component\\CssSelector\\Node\\PseudoNode" =>
        $vendorDir . "/symfony/css-selector/Node/PseudoNode.php",
    "Symfony\\Component\\CssSelector\\Node\\SelectorNode" =>
        $vendorDir . "/symfony/css-selector/Node/SelectorNode.php",
    "Symfony\\Component\\CssSelector\\Node\\Specificity" =>
        $vendorDir . "/symfony/css-selector/Node/Specificity.php",
    "Symfony\\Component\\CssSelector\\Node\\SpecificityAdjustmentNode" =>
        $vendorDir . "/symfony/css-selector/Node/SpecificityAdjustmentNode.php",
    "Symfony\\Component\\CssSelector\\Parser\\Handler\\CommentHandler" =>
        $vendorDir . "/symfony/css-selector/Parser/Handler/CommentHandler.php",
    ...
    "Symfony\\Component\\CssSelector\\Parser\\Handler\\HashHandler" =>
        $vendorDir . "/symfony/css-selector/Parser/Handler/HashHandler.php",
    ...
    "Symfony\\Component\\CssSelector\\Parser\\Handler\\NumberHandler" =>
        $vendorDir . "/symfony/css-selector/Parser/Handler/NumberHandler.php",
    "Symfony\\Component\\CssSelector\\Parser\\Handler\\StringHandler" =>
        $vendorDir . "/symfony/css-selector/Parser/Handler/StringHandler.php",
    ...
    "Symfony\\Component\\CssSelector\\Parser\\Parser" =>
        $vendorDir . "/symfony/css-selector/Parser/Parser.php",
    "Symfony\\Component\\CssSelector\\Parser\\ParserInterface" =>
        $vendorDir . "/symfony/css-selector/Parser/ParserInterface.php",
    "Symfony\\Component\\CssSelector\\Parser\\Reader" =>
        $vendorDir . "/symfony/css-selector/Parser/Reader.php",
    "Symfony\\Component\\CssSelector\\Parser\\Shortcut\\ClassParser" =>
        $vendorDir . "/symfony/css-selector/Parser/Shortcut/ClassParser.php",
    "Symfony\\Component\\CssSelector\\Parser\\Shortcut\\ElementParser" =>
        $vendorDir . "/symfony/css-selector/Parser/Shortcut/ElementParser.php",
    ...
    "Symfony\\Component\\CssSelector\\Parser\\Shortcut\\HashParser" =>
        $vendorDir . "/symfony/css-selector/Parser/Shortcut/HashParser.php",
    "Symfony\\Component\\CssSelector\\Parser\\Token" =>
        $vendorDir . "/symfony/css-selector/Parser/Token.php",
    "Symfony\\Component\\CssSelector\\Parser\\TokenStream" =>
        $vendorDir . "/symfony/css-selector/Parser/TokenStream.php",
    "Symfony\\Component\\CssSelector\\Parser\\Tokenizer\\Tokenizer" =>
        $vendorDir . "/symfony/css-selector/Parser/Tokenizer/Tokenizer.php",
    ...
    "Symfony\\Component\\CssSelector\\XPath\\Extension\\HtmlExtension" =>
        $vendorDir . "/symfony/css-selector/XPath/Extension/HtmlExtension.php",
    "Symfony\\Component\\CssSelector\\XPath\\Extension\\NodeExtension" =>
        $vendorDir . "/symfony/css-selector/XPath/Extension/NodeExtension.php",
    ...
    "Symfony\\Component\\CssSelector\\XPath\\Translator" =>
        $vendorDir . "/symfony/css-selector/XPath/Translator.php",
    "Symfony\\Component\\CssSelector\\XPath\\TranslatorInterface" =>
        $vendorDir . "/symfony/css-selector/XPath/TranslatorInterface.php",
    "Symfony\\Component\\CssSelector\\XPath\\XPathExpr" =>
        $vendorDir . "/symfony/css-selector/XPath/XPathExpr.php",
    "Symfony\\Component\\Yaml\\Command\\LintCommand" =>
        $vendorDir . "/symfony/yaml/Command/LintCommand.php",
    "Symfony\\Component\\Yaml\\Dumper" =>
        $vendorDir . "/symfony/yaml/Dumper.php",
    "Symfony\\Component\\Yaml\\Escaper" =>
        $vendorDir . "/symfony/yaml/Escaper.php",
    ...
    "Symfony\\Component\\Yaml\\Exception\\ExceptionInterface" =>
        $vendorDir . "/symfony/yaml/Exception/ExceptionInterface.php",
    ...
    "Symfony\\Component\\Yaml\\Inline" =>
        $vendorDir . "/symfony/yaml/Inline.php",
    "Symfony\\Component\\Yaml\\Parser" =>
        $vendorDir . "/symfony/yaml/Parser.php",
    "Symfony\\Component\\Yaml\\Tag\\TaggedValue" =>
        $vendorDir . "/symfony/yaml/Tag/TaggedValue.php",
    "Symfony\\Component\\Yaml\\Unescaper" =>
        $vendorDir . "/symfony/yaml/Unescaper.php",
    "Symfony\\Component\\Yaml\\Yaml" => $vendorDir . "/symfony/yaml/Yaml.php",
    "Symfony\\Polyfill\\Ctype\\Ctype" =>
        $vendorDir . "/symfony/polyfill-ctype/Ctype.php",
    "Symfony\\Polyfill\\Intl\\Idn\\Idn" =>
        $vendorDir . "/symfony/polyfill-intl-idn/Idn.php",
    "Symfony\\Polyfill\\Intl\\Idn\\Info" =>
        $vendorDir . "/symfony/polyfill-intl-idn/Info.php",
    ...
    "Symfony\\Polyfill\\Intl\\Idn\\Resources\\unidata\\Regex" =>
        $vendorDir . "/symfony/polyfill-intl-idn/Resources/unidata/Regex.php",
    "Symfony\\Polyfill\\Intl\\Normalizer\\Normalizer" =>
        $vendorDir . "/symfony/polyfill-intl-normalizer/Normalizer.php",
    "Symfony\\Polyfill\\Mbstring\\Mbstring" =>
        $vendorDir . "/symfony/polyfill-mbstring/Mbstring.php",
    ...
    "Tests\\Unit\\Config\\BrandColorsTest" =>
        $baseDir . "/tests/Unit/Config/BrandColorsTest.php",
    "Tests\\Unit\\Config\\SpacingUtilityClassesTest" =>
        $baseDir . "/tests/Unit/Config/SpacingUtilityClassesTest.php",
    "TheSeer\\Tokenizer\\Exception" =>
        $vendorDir . "/theseer/tokenizer/src/Exception.php",
    "TheSeer\\Tokenizer\\NamespaceUri" =>
        $vendorDir . "/theseer/tokenizer/src/NamespaceUri.php",
    "TheSeer\\Tokenizer\\NamespaceUriException" =>
        $vendorDir . "/theseer/tokenizer/src/NamespaceUriException.php",
    "TheSeer\\Tokenizer\\Token" =>
        $vendorDir . "/theseer/tokenizer/src/Token.php",
    "TheSeer\\Tokenizer\\TokenCollection" =>
        $vendorDir . "/theseer/tokenizer/src/TokenCollection.php",
    "TheSeer\\Tokenizer\\TokenCollectionException" =>
        $vendorDir . "/theseer/tokenizer/src/TokenCollectionException.php",
    "TheSeer\\Tokenizer\\Tokenizer" =>
        $vendorDir . "/theseer/tokenizer/src/Tokenizer.php",
    "TheSeer\\Tokenizer\\XMLSerializer" =>
        $vendorDir . "/theseer/tokenizer/src/XMLSerializer.php",
    "Whoops\\Exception\\ErrorException" =>
        $vendorDir . "/filp/whoops/src/Whoops/Exception/ErrorException.php",
    "Whoops\\Exception\\Formatter" =>
        $vendorDir . "/filp/whoops/src/Whoops/Exception/Formatter.php",
    "Whoops\\Exception\\Frame" =>
        $vendorDir . "/filp/whoops/src/Whoops/Exception/Frame.php",
    "Whoops\\Exception\\FrameCollection" =>
        $vendorDir . "/filp/whoops/src/Whoops/Exception/FrameCollection.php",
    "Whoops\\Exception\\Inspector" =>
        $vendorDir . "/filp/whoops/src/Whoops/Exception/Inspector.php",
    "Whoops\\Handler\\CallbackHandler" =>
        $vendorDir . "/filp/whoops/src/Whoops/Handler/CallbackHandler.php",
    "Whoops\\Handler\\Handler" =>
        $vendorDir . "/filp/whoops/src/Whoops/Handler/Handler.php",
    "Whoops\\Handler\\HandlerInterface" =>
        $vendorDir . "/filp/whoops/src/Whoops/Handler/HandlerInterface.php",
    "Whoops\\Handler\\JsonResponseHandler" =>
        $vendorDir . "/filp/whoops/src/Whoops/Handler/JsonResponseHandler.php",
    "Whoops\\Handler\\PlainTextHandler" =>
        $vendorDir . "/filp/whoops/src/Whoops/Handler/PlainTextHandler.php",
    "Whoops\\Handler\\PrettyPageHandler" =>
        $vendorDir . "/filp/whoops/src/Whoops/Handler/PrettyPageHandler.php",
    "Whoops\\Handler\\XmlResponseHandler" =>
        $vendorDir . "/filp/whoops/src/Whoops/Handler/XmlResponseHandler.php",
    "Whoops\\Inspector\\InspectorFactory" =>
        $vendorDir . "/filp/whoops/src/Whoops/Inspector/InspectorFactory.php",
    ...
    "Whoops\\Inspector\\InspectorInterface" =>
        $vendorDir . "/filp/whoops/src/Whoops/Inspector/InspectorInterface.php",
    "Whoops\\Run" => $vendorDir . "/filp/whoops/src/Whoops/Run.php",
    "Whoops\\RunInterface" =>
        $vendorDir . "/filp/whoops/src/Whoops/RunInterface.php",
    "Whoops\\Util\\HtmlDumperOutput" =>
        $vendorDir . "/filp/whoops/src/Whoops/Util/HtmlDumperOutput.php",
    "Whoops\\Util\\Misc" =>
        $vendorDir . "/filp/whoops/src/Whoops/Util/Misc.php",
    "Whoops\\Util\\SystemFacade" =>
        $vendorDir . "/filp/whoops/src/Whoops/Util/SystemFacade.php",
    "Whoops\\Util\\TemplateHelper" =>
        $vendorDir . "/filp/whoops/src/Whoops/Util/TemplateHelper.php",
    "claviska\\SimpleImage" =>
        $vendorDir . "/claviska/simpleimage/src/claviska/SimpleImage.php",
    "staabm\\SideEffectsDetector\\SideEffect" =>
        $vendorDir . "/staabm/side-effects-detector/lib/SideEffect.php",
    ...
    "voku\\helper\\HtmlDomHelper" =>
        $vendorDir . "/voku/simple_html_dom/src/voku/helper/HtmlDomHelper.php",
    "voku\\helper\\HtmlDomParser" =>
        $vendorDir . "/voku/simple_html_dom/src/voku/helper/HtmlDomParser.php",
    "voku\\helper\\HtmlMin" =>
        $vendorDir . "/voku/html-min/src/voku/helper/HtmlMin.php",
    ...
    "voku\\helper\\HtmlMinInterface" =>
        $vendorDir . "/voku/html-min/src/voku/helper/HtmlMinInterface.php",
    ...
    "voku\\helper\\SimpleHtmlDom" =>
        $vendorDir . "/voku/simple_html_dom/src/voku/helper/SimpleHtmlDom.php",
    ...
    "voku\\helper\\SimpleXmlDom" =>
        $vendorDir . "/voku/simple_html_dom/src/voku/helper/SimpleXmlDom.php",
    ...
    "voku\\helper\\XmlDomParser" =>
        $vendorDir . "/voku/simple_html_dom/src/voku/helper/XmlDomParser.php",
];
