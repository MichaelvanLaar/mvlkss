...
final class Mbstring {
    ...
    public static function mb_convert_encoding(
        ...
        if (
            ...
            (null !== $fromEncoding && false !== strpos($fromEncoding, ","))
        ) {
    ...
    public static function mb_lcfirst(
        string $string,
        ?string $encoding = null,
    ): string {
        if (null === $encoding) {
    ...
    public static function mb_trim(
        string $string,
        ?string $characters = null,
        ?string $encoding = null,
    ): string {
        return self::mb_internal_trim(
            '{^[%s]+|[%1$s]+$}Du',
            $string,
            $characters,
            $encoding,
    ...
    public static function mb_ltrim(
        string $string,
        ?string $characters = null,
        ?string $encoding = null,
    ): string {
    ...
    public static function mb_rtrim(
        string $string,
        ?string $characters = null,
        ?string $encoding = null,
    ): string {
    ...
    private static function mb_internal_trim(
        string $regex,
        string $string,
        ?string $characters,
        ?string $encoding,
        ...
        if (null === $encoding) {
            ...
            self::assertEncoding(
                $encoding,
                $function .
                    '(): Argument #3 ($encoding) must be a valid encoding, "%s" given',
            );
        }
        ...
        if ("" === $characters) {
            return null === $encoding
                ? $string
                : self::mb_convert_encoding($string, $encoding);
        }
    ...
    private static function assertEncoding(
        string $encoding,
        string $errorFormat,
    ): void {
        try {
