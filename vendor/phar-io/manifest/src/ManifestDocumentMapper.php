...
class ManifestDocumentMapper {
    ...
    private function mapRequirements(
        RequiresElement $requires,
    ...
    private function mapBundledComponents(
        ...
        foreach (
            $document->getBundlesElement()->getComponentElements()
            as $componentElement
        ) {
            $collection->add(
                new BundledComponent(
                    $componentElement->getName(),
                    new Version($componentElement->getVersion()),
                ),
            );
        }
    ...
    private function mapExtension(ExtensionElement $extension): Extension {
        try {
            $versionConstraint = (new VersionConstraintParser())->parse(
                $extension->getCompatible(),
            );
