    ...
    public function getMessage() {
        ...
        static $messages = [
            ...
            self::EXCLUSIVE_MINIMUM =>
                "Must have a minimum value greater than %d",
            ...
            self::MAX_ITEMS =>
                "There must be a maximum of %d items in the array, %d found",
            self::MAXIMUM =>
                "Must have a maximum value less than or equal to %d",
            self::MIN_ITEMS =>
                "There must be a minimum of %d items in the array, %d found",
            self::MINIMUM =>
                "Must have a minimum value greater than or equal to %d",
            self::MISSING_MAXIMUM =>
                "Use of exclusiveMaximum requires presence of maximum",
            self::MISSING_MINIMUM =>
            ...
            self::CONTENT_MEDIA_TYPE =>
                "Value is not valid with content media type",
            self::CONTENT_ENCODING =>
                "Value is not valid with content encoding",
        ];

        if (!isset($messages[$name])) {
            throw new InvalidArgumentException(
                "Missing error message for " . $name,
            );
        }
