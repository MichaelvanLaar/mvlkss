    ...
    public function check(
        ...
        foreach ($properties as $propertyName => $propertyValue) {
            foreach (
                ...
                as $patternPropertyRegex => $patternPropertySchema
            ) {
                $matchPattern = $this->createPregMatchPattern(
                    $patternPropertyRegex,
                );
                if (preg_match($matchPattern, (string) $propertyName)) {
                    $schemaConstraint = $this->factory->createInstanceFor(
                        "schema",
                    );
