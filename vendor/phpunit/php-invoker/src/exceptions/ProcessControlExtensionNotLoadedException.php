...
final class ProcessControlExtensionNotLoadedException
    ...
    public function __construct() {
        ...
        if (!extension_loaded("pcntl")) {
            $message[] =
                "The pcntl (process control) extension for PHP must be loaded.";
        }
        ...
        if (!function_exists("pcntl_async_signals")) {
            $message[] =
                "The pcntl_async_signals() function must not be disabled.";
        }
