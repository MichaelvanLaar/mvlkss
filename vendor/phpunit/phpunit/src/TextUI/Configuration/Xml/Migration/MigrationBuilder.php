...
final readonly class MigrationBuilder {
    private const AVAILABLE_MIGRATIONS = [
        ...
        "10.0" => [MoveCoverageDirectoriesToSource::class],

        "10.4" => [RemoveBeStrictAboutTodoAnnotatedTestsAttribute::class],

        "10.5" => [
            RemoveRegisterMockObjectsFromTestArgumentsRecursivelyAttribute::class,
        ],

        "11.0" => [ReplaceRestrictDeprecationsWithIgnoreDeprecations::class],
        ...
        "11.2" => [RemoveBeStrictAboutTodoAnnotatedTestsAttribute::class],
    ];
