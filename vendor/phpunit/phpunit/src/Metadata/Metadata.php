...
abstract readonly class Metadata {
    ...
    public static function backupStaticPropertiesOnClass(
        bool $enabled,
    ): BackupStaticProperties {
        return new BackupStaticProperties(self::CLASS_LEVEL, $enabled);
    }

    public static function backupStaticPropertiesOnMethod(
        bool $enabled,
    ): BackupStaticProperties {
     ...
     */
    public static function coversMethod(
        string $className,
        string $methodName,
    ): CoversMethod {
     ...
     */
    public static function coversFunction(
        string $functionName,
    ): CoversFunction {
     ...
     * @param class-string $className
     */
    public static function coversDefaultClass(
        string $className,
    ): CoversDefaultClass {
     ...
     * @param class-string $className
     */
    public static function dependsOnClass(
        string $className,
        bool $deepClone,
        bool $shallowClone,
    ): DependsOnClass {
        return new DependsOnClass(
            self::METHOD_LEVEL,
            $className,
            $deepClone,
            $shallowClone,
     ...
     * @param non-empty-string $methodName
     */
    public static function dependsOnMethod(
        string $className,
        string $methodName,
        bool $deepClone,
        bool $shallowClone,
    ...
    public static function disableReturnValueGenerationForTestDoubles(): DisableReturnValueGenerationForTestDoubles {
        return new DisableReturnValueGenerationForTestDoubles(
            self::CLASS_LEVEL,
        );
    }
     ...
     */
    public static function excludeGlobalVariableFromBackupOnClass(
        string $globalVariableName,
    ): ExcludeGlobalVariableFromBackup {
        return new ExcludeGlobalVariableFromBackup(
            self::CLASS_LEVEL,
            $globalVariableName,
        );
    }
     ...
     */
    public static function excludeStaticPropertyFromBackupOnClass(
        string $className,
        string $propertyName,
    ): ExcludeStaticPropertyFromBackup {
        return new ExcludeStaticPropertyFromBackup(
            self::CLASS_LEVEL,
            $className,
            $propertyName,
        );
     ...
     * @param non-empty-string $propertyName
     */
    public static function excludeStaticPropertyFromBackupOnMethod(
        string $className,
        string $propertyName,
    ): ExcludeStaticPropertyFromBackup {
        return new ExcludeStaticPropertyFromBackup(
    ...
    public static function preserveGlobalStateOnClass(
        bool $enabled,
    ): PreserveGlobalState {
        return new PreserveGlobalState(self::CLASS_LEVEL, $enabled);
    }

    public static function preserveGlobalStateOnMethod(
        bool $enabled,
    ): PreserveGlobalState {
     ...
     * @param non-empty-string $functionName
     */
    public static function requiresFunctionOnMethod(
        string $functionName,
    ): RequiresFunction {
     ...
     * @param non-empty-string $methodName
     */
    public static function requiresMethodOnClass(
        string $className,
        string $methodName,
    ): RequiresMethod {
     ...
     * @param non-empty-string $methodName
     */
    public static function requiresMethodOnMethod(
        string $className,
        string $methodName,
    ): RequiresMethod {
     ...
     * @param non-empty-string $operatingSystem
     */
    public static function requiresOperatingSystemOnMethod(
        string $operatingSystem,
    ): RequiresOperatingSystem {
        return new RequiresOperatingSystem(
            self::METHOD_LEVEL,
            $operatingSystem,
        );
    }
     ...
     */
    public static function requiresOperatingSystemFamilyOnClass(
     ...
     * @param non-empty-string $operatingSystemFamily
     */
    public static function requiresOperatingSystemFamilyOnMethod(
        string $operatingSystemFamily,
    ): RequiresOperatingSystemFamily {
        return new RequiresOperatingSystemFamily(
            self::METHOD_LEVEL,
    ...
    public static function requiresPhpOnMethod(
        Requirement $versionRequirement,
    ): RequiresPhp {
     ...
     */
    public static function requiresPhpExtensionOnClass(
        string $extension,
        ?Requirement $versionRequirement,
    ): RequiresPhpExtension {
        return new RequiresPhpExtension(
            self::CLASS_LEVEL,
            $extension,
            $versionRequirement,
        );
     ...
     * @param non-empty-string $extension
     */
    public static function requiresPhpExtensionOnMethod(
        string $extension,
        ?Requirement $versionRequirement,
    ): RequiresPhpExtension {
        return new RequiresPhpExtension(
    ...
    public static function requiresPhpunitOnClass(
        Requirement $versionRequirement,
    ): RequiresPhpunit {
        return new RequiresPhpunit(self::CLASS_LEVEL, $versionRequirement);
    }

    public static function requiresPhpunitOnMethod(
        Requirement $versionRequirement,
    ): RequiresPhpunit {
     ...
     */
    public static function requiresPhpunitExtensionOnClass(
     ...
     * @param class-string<Extension> $extensionClass
     */
    public static function requiresPhpunitExtensionOnMethod(
        string $extensionClass,
    ): RequiresPhpunitExtension {
        return new RequiresPhpunitExtension(
            self::METHOD_LEVEL,
            $extensionClass,
        );
    }
     ...
     */
    public static function requiresSettingOnClass(
        string $setting,
        string $value,
    ): RequiresSetting {
     ...
     * @param non-empty-string $value
     */
    public static function requiresSettingOnMethod(
        string $setting,
        string $value,
    ): RequiresSetting {
     ...
     * @param non-empty-string $methodName
     */
    public static function usesMethod(
        string $className,
        string $methodName,
    ): UsesMethod {
     ...
     * @param class-string $className
     */
    public static function usesDefaultClass(
        string $className,
    ): UsesDefaultClass {
