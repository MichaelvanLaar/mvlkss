...
abstract class Assert {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertArrayIsIdenticalToArrayOnlyConsideringListOfKeys(
        array $expected,
        array $actual,
        array $keysToBeConsidered,
        string $message = "",
    ): void {
        $keysToBeConsidered = array_combine(
            $keysToBeConsidered,
            $keysToBeConsidered,
        );
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertArrayIsIdenticalToArrayIgnoringListOfKeys(
        array $expected,
        array $actual,
        array $keysToBeIgnored,
        string $message = "",
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertArrayHasKey(
        mixed $key,
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertArrayNotHasKey(
        mixed $key,
        array|ArrayAccess $array,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertIsList(
        mixed $array,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContains(
        mixed $needle,
        iterable $haystack,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsEquals(
        mixed $needle,
        iterable $haystack,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertNotContains(
        mixed $needle,
        iterable $haystack,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertNotContainsEquals(
        mixed $needle,
        iterable $haystack,
        string $message = "",
    ): void {
     ...
     */
    final public static function assertContainsOnly(
        string $type,
        iterable $haystack,
        ...
        self::assertThat(
            $haystack,
            new TraversableContainsOnly($type, $isNativeType),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsOnlyArray(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::Array->value),
            $message,
        );
    }
    ...
    final public static function assertContainsOnlyBool(
        ...
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::Bool->value),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsOnlyCallable(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::Callable->value),
            $message,
        );
    }
    ...
    final public static function assertContainsOnlyFloat(
        ...
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::Float->value),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsOnlyInt(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::Int->value),
            $message,
        );
    }
    ...
    final public static function assertContainsOnlyIterable(
        ...
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::Iterable->value),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsOnlyNull(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::Null->value),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsOnlyNumeric(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::Numeric->value),
            $message,
        );
    }
    ...
    final public static function assertContainsOnlyObject(
        ...
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::Object->value),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsOnlyResource(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::Resource->value),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsOnlyClosedResource(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::ClosedResource->value),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsOnlyScalar(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::Scalar->value),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsOnlyString(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
            $haystack,
            new TraversableContainsOnly(NativeType::String->value),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsOnlyInstancesOf(
        string $className,
        iterable $haystack,
        string $message = "",
    ): void {
     ...
     * @deprecated https://github.com/sebastianbergmann/phpunit/issues/6055
     */
    final public static function assertNotContainsOnly(
        string $type,
        iterable $haystack,
        ?bool $isNativeType = null,
        string $message = "",
        ...
        self::assertThat(
            $haystack,
            new LogicalNot(new TraversableContainsOnly($type, $isNativeType)),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsNotOnlyArray(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsNotOnlyBool(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsNotOnlyCallable(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsNotOnlyInt(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
            $haystack,
            new LogicalNot(new TraversableContainsOnly(NativeType::Int->value)),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsNotOnlyIterable(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsNotOnlyNull(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsNotOnlyResource(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsNotOnlyClosedResource(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsNotOnlyScalar(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsNotOnlyString(
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertContainsNotOnlyInstancesOf(
        string $className,
        iterable $haystack,
        string $message = "",
    ): void {
        self::assertThat(
            $haystack,
            new LogicalNot(new TraversableContainsOnly($className, false)),
            $message,
        );
    }
     ...
     */
    final public static function assertCount(
        int $expectedCount,
        Countable|iterable $haystack,
        string $message = "",
    ): void {
        if ($haystack instanceof Generator) {
            throw GeneratorNotSupportedException::fromParameterName(
                '$haystack',
            );
        }

        self::assertThat($haystack, new Count($expectedCount), $message);
    }
     ...
     * @throws GeneratorNotSupportedException
     */
    final public static function assertNotCount(
        int $expectedCount,
        Countable|iterable $haystack,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertEquals(
        mixed $expected,
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertEqualsCanonicalizing(
        mixed $expected,
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertEqualsIgnoringCase(
        mixed $expected,
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertNotEqualsCanonicalizing(
        mixed $expected,
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertNotEqualsIgnoringCase(
        mixed $expected,
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertNotEqualsWithDelta(
        mixed $expected,
        mixed $actual,
        float $delta,
        string $message = "",
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertObjectEquals(
        object $expected,
        object $actual,
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertObjectNotEquals(
        object $expected,
        object $actual,
        string $method = "equals",
        string $message = "",
     ...
     * @throws GeneratorNotSupportedException
     */
    final public static function assertEmpty(
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @throws GeneratorNotSupportedException
     */
    final public static function assertNotEmpty(
        mixed $actual,
        string $message = "",
    ): void {
        if ($actual instanceof Generator) {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertGreaterThan(
        mixed $minimum,
        mixed $actual,
        string $message = "",
    ): void {
    ...
    final public static function assertGreaterThanOrEqual(
        ...
        self::assertThat($actual, self::greaterThanOrEqual($minimum), $message);
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertLessThan(
        mixed $maximum,
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertLessThanOrEqual(
        mixed $maximum,
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertFileEquals(
        string $expected,
        string $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertFileEqualsCanonicalizing(
        string $expected,
        string $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertFileEqualsIgnoringCase(
        string $expected,
        string $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertFileNotEquals(
        string $expected,
        string $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertFileNotEqualsIgnoringCase(
        string $expected,
        string $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertStringEqualsFile(
        string $expectedFile,
        string $actualString,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertStringEqualsFileCanonicalizing(
        string $expectedFile,
        string $actualString,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertStringEqualsFileIgnoringCase(
        string $expectedFile,
        string $actualString,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertStringNotEqualsFile(
        string $expectedFile,
        string $actualString,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertStringNotEqualsFileCanonicalizing(
        string $expectedFile,
        string $actualString,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertStringNotEqualsFileIgnoringCase(
        string $expectedFile,
        string $actualString,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertIsReadable(
        string $filename,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertIsNotReadable(
        string $filename,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertIsWritable(
        string $filename,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertDirectoryExists(
        string $directory,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertDirectoryDoesNotExist(
        string $directory,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertDirectoryIsReadable(
        string $directory,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertDirectoryIsNotReadable(
        string $directory,
        string $message = "",
    ): void {
        self::assertDirectoryExists($directory, $message);
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertDirectoryIsNotWritable(
        string $directory,
        string $message = "",
    ): void {
        self::assertDirectoryExists($directory, $message);
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertFileExists(
        string $filename,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertFileDoesNotExist(
        string $filename,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertFileIsReadable(
        string $file,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertFileIsNotReadable(
        string $file,
        string $message = "",
    ): void {
        self::assertFileExists($file, $message);
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertFileIsWritable(
        string $file,
        string $message = "",
    ): void {
        self::assertFileExists($file, $message);
     ...
     */
    final public static function assertTrue(
        mixed $condition,
        string $message = "",
    ): void {
     ...
     * @phpstan-assert !true $condition
     */
    final public static function assertNotTrue(
        mixed $condition,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     */
    final public static function assertFalse(
        mixed $condition,
        string $message = "",
    ): void {
     ...
     * @phpstan-assert !false $condition
     */
    final public static function assertNotFalse(
        mixed $condition,
        string $message = "",
    ): void {
        self::assertThat(
            $condition,
            self::logicalNot(self::isFalse()),
            $message,
        );
    }
     ...
     */
    final public static function assertNull(
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @phpstan-assert !null $actual
     */
    final public static function assertNotNull(
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertInfinite(
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertNan(
        mixed $actual,
        string $message = "",
    ): void {
    ...
    final public static function assertObjectNotHasProperty(
        ...
        self::assertThat(
            $object,
            new LogicalNot(new ObjectHasProperty($propertyName)),
            $message,
        );
    }
     ...
     */
    final public static function assertSame(
        mixed $expected,
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertNotSame(
        mixed $expected,
        mixed $actual,
        string $message = "",
    ): void {
        ...
        self::assertThat(
            $actual,
            new LogicalNot(new IsIdentical($expected)),
            $message,
        );
    }
     ...
     * @phpstan-assert =ExpectedType $actual
     */
    final public static function assertInstanceOf(
        string $expected,
        mixed $actual,
        string $message = "",
    ): void {
     ...
     * @phpstan-assert !ExpectedType $actual
     */
    final public static function assertNotInstanceOf(
        string $expected,
        mixed $actual,
        string $message = "",
    ): void {
        ...
        self::assertThat(
            $actual,
            new LogicalNot(new IsInstanceOf($expected)),
            $message,
        );
    }
     ...
     */
    final public static function assertIsArray(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat($actual, new IsType(IsType::TYPE_ARRAY), $message);
    }
     ...
     */
    final public static function assertIsBool(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat($actual, new IsType(IsType::TYPE_BOOL), $message);
    }
     ...
     */
    final public static function assertIsFloat(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat($actual, new IsType(IsType::TYPE_FLOAT), $message);
    }
     ...
     */
    final public static function assertIsInt(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat($actual, new IsType(IsType::TYPE_INT), $message);
    }
     ...
     */
    final public static function assertIsNumeric(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat($actual, new IsType(IsType::TYPE_NUMERIC), $message);
    }
     ...
     */
    final public static function assertIsObject(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat($actual, new IsType(IsType::TYPE_OBJECT), $message);
    }
     ...
     */
    final public static function assertIsResource(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat($actual, new IsType(IsType::TYPE_RESOURCE), $message);
    }
     ...
     * @phpstan-assert resource $actual
     */
    final public static function assertIsClosedResource(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     */
    final public static function assertIsString(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat($actual, new IsType(IsType::TYPE_STRING), $message);
    }
     ...
     */
    final public static function assertIsScalar(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat($actual, new IsType(IsType::TYPE_SCALAR), $message);
    }
     ...
     */
    final public static function assertIsCallable(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat($actual, new IsType(IsType::TYPE_CALLABLE), $message);
    }
     ...
     */
    final public static function assertIsIterable(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat($actual, new IsType(IsType::TYPE_ITERABLE), $message);
    }
     ...
     * @phpstan-assert !array<mixed> $actual
     */
    final public static function assertIsNotArray(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @phpstan-assert !bool $actual
     */
    final public static function assertIsNotBool(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @phpstan-assert !float $actual
     */
    final public static function assertIsNotFloat(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @phpstan-assert !int $actual
     */
    final public static function assertIsNotInt(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @phpstan-assert !numeric $actual
     */
    final public static function assertIsNotNumeric(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @phpstan-assert !object $actual
     */
    final public static function assertIsNotObject(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @phpstan-assert !resource $actual
     */
    final public static function assertIsNotResource(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @phpstan-assert !resource $actual
     */
    final public static function assertIsNotClosedResource(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @phpstan-assert !string $actual
     */
    final public static function assertIsNotString(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @phpstan-assert !scalar $actual
     */
    final public static function assertIsNotScalar(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @phpstan-assert !callable $actual
     */
    final public static function assertIsNotCallable(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @phpstan-assert !iterable<mixed> $actual
     */
    final public static function assertIsNotIterable(
        mixed $actual,
        string $message = "",
    ): void {
        self::assertThat(
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertDoesNotMatchRegularExpression(
        string $pattern,
        string $string,
        string $message = "",
    ): void {
     ...
     * @throws GeneratorNotSupportedException
     */
    final public static function assertSameSize(
        ...
        self::assertThat($actual, new SameSize($expected), $message);
    }
     ...
     * @throws GeneratorNotSupportedException
     */
    final public static function assertNotSameSize(
        Countable|iterable $expected,
        Countable|iterable $actual,
        string $message = "",
    ): void {
        ...
        self::assertThat(
            $actual,
            new LogicalNot(new SameSize($expected)),
            $message,
        );
    }
    ...
    final public static function assertStringContainsStringIgnoringLineEndings(
        ...
        self::assertThat(
            $haystack,
            new StringContains($needle, false, true),
            $message,
        );
    }
    ...
    final public static function assertStringEqualsStringIgnoringLineEndings(
        ...
        self::assertThat(
            $actual,
            new StringEqualsStringIgnoringLineEndings($expected),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertFileMatchesFormat(
        string $format,
        string $actualFile,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertFileMatchesFormatFile(
        string $formatFile,
        string $actualFile,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertStringMatchesFormat(
        string $format,
        string $string,
        string $message = "",
    ): void {
     ...
     */
    final public static function assertStringNotMatchesFormat(
        string $format,
        string $string,
        string $message = "",
    ): void {
        ...
        self::assertThat(
            $string,
            new LogicalNot(new StringMatchesFormatDescription($format)),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertStringMatchesFormatFile(
        string $formatFile,
        string $string,
        string $message = "",
    ): void {
     ...
     * @deprecated https://github.com/sebastianbergmann/phpunit/issues/5472
     */
    final public static function assertStringNotMatchesFormatFile(
        string $formatFile,
        string $string,
        string $message = "",
    ): void {
     ...
     */
    final public static function assertStringStartsWith(
        string $prefix,
        string $string,
        string $message = "",
    ): void {
     ...
     * @throws InvalidArgumentException
     */
    final public static function assertStringStartsNotWith(
        string $prefix,
        string $string,
        string $message = "",
    ): void {
        self::assertThat(
            $string,
            new LogicalNot(new StringStartsWith($prefix)),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertStringContainsStringIgnoringCase(
        string $needle,
        string $haystack,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertStringNotContainsString(
        string $needle,
        string $haystack,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertStringNotContainsStringIgnoringCase(
        string $needle,
        string $haystack,
        string $message = "",
    ): void {
     ...
     * @throws InvalidArgumentException
     */
    final public static function assertStringEndsWith(
        string $suffix,
        string $string,
        string $message = "",
    ): void {
     ...
     * @throws InvalidArgumentException
     */
    final public static function assertStringEndsNotWith(
        string $suffix,
        string $string,
        string $message = "",
    ): void {
        self::assertThat(
            $string,
            new LogicalNot(new StringEndsWith($suffix)),
            $message,
        );
    }
     ...
     * @throws XmlException
     */
    final public static function assertXmlFileEqualsXmlFile(
        string $expectedFile,
        string $actualFile,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertXmlFileNotEqualsXmlFile(
        string $expectedFile,
        string $actualFile,
        string $message = "",
    ): void {
     ...
     * @throws XmlException
     */
    final public static function assertXmlStringEqualsXmlFile(
        string $expectedFile,
        string $actualXml,
        string $message = "",
    ): void {
     ...
     * @throws XmlException
     */
    final public static function assertXmlStringNotEqualsXmlFile(
        string $expectedFile,
        string $actualXml,
        string $message = "",
    ): void {
     ...
     * @throws XmlException
     */
    final public static function assertXmlStringEqualsXmlString(
        string $expectedXml,
        string $actualXml,
        string $message = "",
    ): void {
     ...
     * @throws XmlException
     */
    final public static function assertXmlStringNotEqualsXmlString(
        string $expectedXml,
        string $actualXml,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertThat(
        mixed $value,
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertJson(
        string $actual,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertJsonStringEqualsJsonString(
        string $expectedJson,
        string $actualJson,
        string $message = "",
    ): void {
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertJsonStringNotEqualsJsonString(
        string $expectedJson,
        string $actualJson,
        string $message = "",
    ): void {
        ...
        self::assertThat(
            $actualJson,
            new LogicalNot(new JsonMatches($expectedJson)),
            $message,
        );
    }
     ...
     * @throws ExpectationFailedException
     */
    final public static function assertJsonStringNotEqualsJsonFile(
        string $expectedFile,
        string $actualJson,
        string $message = "",
    ): void {
    ...
    final public static function assertJsonFileNotEqualsJsonFile(
        ...
        self::assertThat(
            $actualJson,
            self::logicalNot(new JsonMatches($expectedJson)),
            $message,
        );
    }
    ...
    final public static function logicalNot(
        Constraint $constraint,
    ): LogicalNot {
    ...
    final public static function containsEqual(
        mixed $value,
    ): TraversableContainsEqual {
        return new TraversableContainsEqual($value);
    }

    final public static function containsIdentical(
        mixed $value,
     ...
     * @deprecated https://github.com/sebastianbergmann/phpunit/issues/6055
     */
    final public static function containsOnly(
        string $type,
     ...
     * @throws Exception
     */
    final public static function containsOnlyInstancesOf(
        string $className,
    ): TraversableContainsOnly {
    ...
    final public static function equalToCanonicalizing(
        mixed $value,
    ): IsEqualCanonicalizing {
        return new IsEqualCanonicalizing($value);
    }

    final public static function equalToIgnoringCase(
        mixed $value,
    ): IsEqualIgnoringCase {
    ...
    final public static function greaterThanOrEqual(mixed $value): LogicalOr {
        return self::logicalOr(new IsEqual($value), new GreaterThan($value));
    }
    ...
    final public static function lessThanOrEqual(mixed $value): LogicalOr {
        return self::logicalOr(new IsEqual($value), new LessThan($value));
    }

    final public static function matchesRegularExpression(
        string $pattern,
    ): RegularExpression {
        return new RegularExpression($pattern);
    }

    final public static function matches(
        string $string,
     ...
     * @throws InvalidArgumentException
     */
    final public static function stringStartsWith(
        string $prefix,
    ): StringStartsWith {
        return new StringStartsWith($prefix);
    }

    final public static function stringContains(
        string $string,
        bool $case = true,
    ): StringContains {
     ...
     * @throws InvalidArgumentException
     */
    final public static function stringEndsWith(
        string $suffix,
    ): StringEndsWith {
        return new StringEndsWith($suffix);
    }

    final public static function stringEqualsStringIgnoringLineEndings(
        string $string,
    ...
    final public static function objectEquals(
        object $object,
        string $method = "equals",
    ): ObjectEquals {
     ...
     */
    final public static function markTestIncomplete(
        string $message = "",
    ): never {
