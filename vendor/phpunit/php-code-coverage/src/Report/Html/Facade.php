...
final class Facade {
    ...
    public function __construct(
        ...
        ?CustomCssFile $customCssFile = null,
    ) {
    ...
    private function copyFiles(string $target): void {
        ...
        copy(
            $this->templatePath . "icons/file-code.svg",
            $dir . "file-code.svg",
        );
        copy(
            $this->templatePath . "icons/file-directory.svg",
            $dir . "file-directory.svg",
        );

        $dir = $this->directory($target . "_js");
        copy(
            $this->templatePath . "js/bootstrap.bundle.min.js",
            $dir . "bootstrap.bundle.min.js",
        );
    ...
    private function renderCss(string $target): void {
        ...
        try {
            $template->renderTo(
                $this->directory($target . "_css") . "style.css",
            );
        } catch (Exception $e) {
