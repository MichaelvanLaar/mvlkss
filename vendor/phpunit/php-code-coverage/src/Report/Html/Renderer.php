...
abstract class Renderer {
    ...
    protected function renderItemTemplate(
        ...
        if (isset($data["numClasses"]) && $data["numClasses"] > 0) {
            ...
            $classesNumber =
                $data["numTestedClasses"] . $numSeparator . $data["numClasses"];
        ...
        if ($data["numMethods"] > 0) {
            ...
            $methodsNumber =
                $data["numTestedMethods"] . $numSeparator . $data["numMethods"];
    ...
    protected function inactiveBreadcrumb(
        AbstractNode $node,
        string $pathToRoot,
    ): string {
        return sprintf(
