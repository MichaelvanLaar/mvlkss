...
final class Cobertura {
    ...
    public function process(
        ...
        $branchRate =
            $branchesValid === 0 ? 0 : $branchesCovered / $branchesValid;
        ...
        foreach ($report as $item) {
            ...
            $packageElement->setAttribute(
                "name",
                str_replace(
                    $report->pathAsString() . DIRECTORY_SEPARATOR,
                    "",
                    $item->pathAsString(),
                ),
            );
            ...
            foreach ($classes as $className => $class) {
                ...
                foreach ($class["methods"] as $methodName => $method) {
                    ...
                    $lineRate =
                        $linesValid === 0 ? 0 : $linesCovered / $linesValid;
                    ...
                    foreach (
                        ...
                        $methodLineElement->setAttribute(
                            "hits",
                            (string) count($coverageData[$line]),
                        );
            ...
            $branchRate =
                $functionsBranchesValid === 0
                    ? 0
                    : $functionsBranchesCovered / $functionsBranchesValid;

            $classElement->setAttribute("line-rate", (string) $lineRate);
            $classElement->setAttribute("branch-rate", (string) $branchRate);
            $classElement->setAttribute(
                "complexity",
                (string) $functionsComplexity,
            );
