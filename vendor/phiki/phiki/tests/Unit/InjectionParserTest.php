...
describe("InjectionParser", function () {
    ...
    it("can parse a multi-part path", function () {
        ...
        $scopes = $injection->getSelector()->composites[0]->expressions[0]
            ->child->scopes;
    ...
    it("can parse a left-prefixed path", function () {
        ...
        $filter = $injection->getSelector()->composites[0]->expressions[0]
            ->child;
    ...
    it("can parse a grouped path", function () {
        ...
        $group = $injection->getSelector()->composites[0]->expressions[0]
            ->child;
    ...
    it("can parse comma-separated paths", function () {
        ...
        $first = $injection->getSelector()->composites[0]->expressions[0]->child
            ->scopes;

        expect($first[0]->__toString())->toBe("text.html.blade.php");

        $second = $injection->getSelector()->composites[1]->expressions[0]
            ->child->scopes;
