...
describe("match", function () {
    it("can tokenize simple match patterns", function () {
        ...
        expect($tokens)->toEqualCanonicalizing([
            [
                ...
                new Token(
                    ["source.test", "keyword.control.test"],
                    "else",
                    3,
                    7,
                ),
        ...
        $tokens = tokenize("function foo() {}", [
            ...
            "patterns" => [
                [
                    ...
                    "match" =>
                        "(function)\\s*([a-zA-Z_\\x{7f}-\\x{10ffff}][a-zA-Z0-9_\\x{7f}-\\x{10ffff}]*)",
                    "captures" => [
                        "1" => [
    ...
    it(
        "can tokenize a match with captures and subpatterns, where the subpatterns are not found",
        function () {
            $tokens = tokenize("namespace Foo;", [
                ...
                "patterns" => [
                    [
                        ...
                        "match" =>
                            "(?i)(?:^|(?<=<\\?php))\\s*(namespace)\\s+([a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)(?=\\s*;)",
                        "captures" => [
                            "1" => [
                            ...
                            "2" => [
                                ...
                                "patterns" => [
                                    [
                                        "match" => "\\\\",
                                        "name" =>
                                            "punctuation.separator.inheritance.test",
                                    ],
                                ],
                            ],
                        ],
            ...
            expect($tokens)->toEqualCanonicalizing([
                [
                    ...
                    new Token(
                        ["source.test", "meta.namespace.test"],
                        " ",
                        9,
                        10,
                    ),
                    new Token(
                        [
                            "source.test",
                            "meta.namespace.test",
                            "entity.name.type.namespace.test",
                        ],
                        "Foo",
                        10,
                        13,
    ...
    it(
        "can tokenize a match with captures and subpatterns, where the subpatterns are found",
        function () {
                ...
                "variable-name" => [
                    "patterns" => [
                        [
                            ...
                            "match" =>
                                '(?i)((\\$)(?<name>[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*))\\s*(?:(\\??->)\\s*(\\g<name>)|(\\[)(?:(\\d+)|((\$)\\g<name>)|([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*))(\\]))?',
                        ],
                        [
                            "captures" => [
                                "1" => [
                            ...
                            "match" =>
                                '(?i)((\\${)(?<name>[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)(}))',
                        ],
                    ],
                ],
            ],
...
describe("begin/end", function () {
    it(
        "can tokenize a simple begin/end pattern without captures and subpatterns",
        function () {
    ...
    it(
        "can tokenize a simple begin/end pattern with beginCaptures and endCaptures",
        function () {
            $tokens = tokenize("begin end", [
                "scopeName" => "source.test",
                "patterns" => [
    ...
    it("can tokenize a simple begin/end patterns with captures", function () {
        ...
        expect($tokens)->toEqualCanonicalizing([
            [
                new Token(
                    ["source.test", "meta.block.test", "keyword.control.test"],
                    "begin",
                    0,
                    5,
                ),
    ...
    it(
        "can tokenize a simple begin/end pattern with beginCaptures that have subpatterns",
        function () {
            $tokens = tokenize("begin end", [
                "scopeName" => "source.test",
                "patterns" => [
    ...
    it(
        "can tokenize a simple begin/end pattern with endCaptures that have subpatterns",
        function () {
            $tokens = tokenize("begin end", [
                "scopeName" => "source.test",
                "patterns" => [
    ...
    it(
        "can tokenize a simple begin/end pattern that has captures with subpatterns",
        function () {
            $tokens = tokenize("begin end", [
                "scopeName" => "source.test",
                "patterns" => [
    ...
    it(
        "can tokenize a begin/end pattern with subpatterns between begin and end",
        function () {
            ...
            expect($tokens)->toEqualCanonicalizing([
                [
                    ...
                    new Token(["source.test", "meta.block.test"], " ", 5, 6),
                    new Token(
                        ["source.test", "meta.block.test", "entity.name.test"],
                        "foo",
                        6,
                        9,
                    ),
    ...
    it(
        "can tokenize a begin/end pattern with subpatterns between begin and end that have captures",
        function () {
            $tokens = tokenize("begin foo end", [
                "scopeName" => "source.test",
                "patterns" => [
    ...
    it(
        "can tokenize a begin/end patterns that have subpatterns and span multiple lines",
        function () {
            $tokens = tokenize(
                <<<'TEST'
                begin
    ...
    it(
        "can tokenize a begin/end patterns that have captures with subpatterns that have captures",
        function () {
            $tokens = tokenize(
                <<<'TEST'
                begin
    ...
    it(
        "adds contentName to the scope stack when processing begin/end patterns",
        function () {
            $tokens = tokenize("begin foo end", [
                "scopeName" => "source.test",
                "patterns" => [
...
describe("scopes", function () {
    it(
        "correctly replaces capture references inside of scope names",
        function () {
            $tokens = tokenize("foo", [
                "scopeName" => "source.test",
                "patterns" => [
