...
describe("php", function () {
    ...
    it(
        "correctly tokenizes a double-quoted string with interpolation",
        function () {
    ...
    it(
        "correctly tokenizes a top-level use statement without namespace separators",
        function () {
            $tokens = php("use A;");
            ...
            expect($tokens)->toEqualCanonicalizing([
                [
                    new Token(
                        ["source.php", "meta.use.php", "keyword.other.use.php"],
                        "use",
                        0,
                        3,
                    ),
                    ...
                    new Token(
                        ["source.php", "meta.use.php", "support.class.php"],
                        "A",
                        4,
                        5,
                    ),
    ...
    it(
        "correctly tokenizes a top-level use statement with namespace separators",
        function () {
    ...
    it(
        "correctly tokenizes a function statement with a typed parameter",
        function () {
    ...
    it(
        "correctly tokenizes a function statement with a qualified typed parameter",
        function () {
    ...
    it(
        "correctly tokenizes a function statement with a union type parameter",
        function () {
