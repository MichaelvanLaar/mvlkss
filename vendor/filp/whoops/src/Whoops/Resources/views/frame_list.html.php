  ...
  <div class="frame <?php echo $i == 0
     ...
     : ""; ?>" id="frame-line-<?php echo $i; ?>">
      ...
      <div class="frame-method-info">
        <span class="frame-class"><?php echo $tpl->breakOnDelimiter(
            "\\",
            $tpl->escape($frame->getClass() ?: ""),
        ); ?></span>
        <span class="frame-function"><?php echo $tpl->breakOnDelimiter(
            "\\",
