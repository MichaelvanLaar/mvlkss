...
$PHPMAILER_LANG["buggy_php"] =
    "Via versio de PHP estas trafita de cimo, kiu povas kaŭzi difektitajn mesaĝojn. Por ripari tion, ŝanĝu al sendado per SMTP, malŝaltu la opcion mail.add_x_header en via php.ini, ŝanĝu al MacOS aŭ Linux, aŭ ĝisdatigu vian PHP al versio 7.0.17+ aŭ 7.1.3+.";
$PHPMAILER_LANG["connect_host"] =
    "SMTP-eraro: Ne eblis konektiĝi al la SMTP-gastiganto.";
...
$PHPMAILER_LANG["provide_address"] =
    "Vi devas provizi almenaŭ unu retpoŝtadreson de ricevonto.";
$PHPMAILER_LANG["recipients_failed"] =
    "SMTP-eraro: La sekva(j) ricevonto(j) malsukcesis: ";
...
$PHPMAILER_LANG["no_smtputf8"] =
    "La servilo ne subtenas SMTPUTF8, kiu estas bezonata por sendi al Unicode-adresoj.";
$PHPMAILER_LANG["imap_recommended"] =
    "Uzado de la simpligita adresanalizilo ne estas rekomendita. Instalu la IMAP-kromprogramon por PHP por plena RFC822-analizado.";
