...
$PHPMAILER_LANG["buggy_php"] =
    "A sua versão do PHP tem um bug que pode causar mensagens corrompidas. Para resolver, utilize o envio por SMTP, desative a opção mail.add_x_header no ficheiro php.ini, mude para MacOS ou Linux, ou atualize o PHP para a versão 7.0.17+ ou 7.1.3+.";
$PHPMAILER_LANG["connect_host"] =
    "Erro SMTP: Não foi possível ligar ao servidor SMTP.";
...
$PHPMAILER_LANG["from_failed"] =
    "O envio falhou para o seguinte endereço do remetente: ";
...
$PHPMAILER_LANG["mailer_not_supported"] =
    "O cliente de e-mail não é suportado.";
$PHPMAILER_LANG["provide_address"] =
    "Deve fornecer pelo menos um endereço de destinatário.";
$PHPMAILER_LANG["recipients_failed"] =
    "Erro SMTP: Falha no envio para os seguintes destinatários: ";
